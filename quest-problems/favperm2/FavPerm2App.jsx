...
import { makeFavPerm2Ch1, makeFavPerm2Ch2 } from "./chapters";
...
export default function FavPerm2App(props = {}) {
  ...
  const setters = { 0: setCh1Q, 1: setCh2Q }, states = { 0: ch1Q, 1: ch2Q }, makers = { 0: makeFavPerm2Ch1, 1: makeFavPerm2Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>🧩 FJ's Fav Perm II</h1>
      ...
      {step.narr && <Narration key={`fp2-${tab}-${cur}-${lang}`} text={step.narr} />}

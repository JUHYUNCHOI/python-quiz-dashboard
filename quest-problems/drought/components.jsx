  ...
  return [
    {
      ...
      cppOnly: [
        t(E, "vector<long long> stores cow amounts because the sum can exceed int range.",
            "vector<long long>로 우유 양 저장 — 합계가 int 범위를 넘을 수 있음."),
        t(E, "A single for-loop sums |a[i] - target| to get the answer.",
            "for문 한 번으로 |a[i] - target| 합을 구해 답을 얻음."),
      ],
    },
  ];
}

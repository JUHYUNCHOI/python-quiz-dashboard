...
export default function Mcc20CipherApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc20CipherCh2(false));
  ...
  const makers  = { 0: makeMcc20CipherCh1, 1: makeMcc20CipherCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd10"} Cipher</h1>
      ...
      {step.narr && <Narration key={`m20ci-${tab}-${cur}-${lang}`} text={step.narr} />}

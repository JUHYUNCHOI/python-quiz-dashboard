...
export default function InnovationApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeInnovationCh2(false));
  ...
  const makers  = { 0: makeInnovationCh1, 1: makeInnovationCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udca1"} Innovation</h1>

...
export default function BovGenomicsApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeGenomicsCh2(false));
  ...
  const makers  = { 0: makeGenomicsCh1, 1: makeGenomicsCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\uddec"} Bovine Genomics</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`bg-${tab}-${cur}-${lang}`} text={step.narr} />}

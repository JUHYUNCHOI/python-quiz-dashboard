...
const PSQ_STK_CPP = [
  ...
  "            }",
  "            memo[start][end][budget] = canMake ? 1 : 0;",
  "            todo.pop_back();",
  "        }",
...
export function getPrintseqStkWalk(E, lang = "py") {
  ...
  return {
    ...
    vars,
    marks: [
      { from: 95, to: 98, color: "#0d9488", ko: "📋 재귀 대신 이것!", en: "📋 instead of recursion!" },
    ],
    beats: [
      { hi: [0, 7], bubble: t(E,

...
export default function BalancedApp(props = {}) {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeBalancedCh3(false));
  ...
  const makers  = { 0: makeBalancedCh1, 1: makeBalancedCh2, 2: makeBalancedCh3 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>🔗 Balanced Subseq</h1>

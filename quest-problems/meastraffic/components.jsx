...
const FULL_CPP = [
  ...
  "        // typ, lo, hi = segments[i]",
  "        if (typ == 'none') {",
  "            auto fwd_lo = max(fwd_lo, lo);",
  "            auto fwd_hi = min(fwd_hi, hi);",
  "        else if (typ == 'on') {",
  "            fwd_lo += lo;",
  "            fwd_hi += hi;",
  "        else if (typ == 'off') {",
  ...
  "            bwd_lo += lo;",
  "            bwd_hi += hi;",
  "        auto bwd_lo = max(bwd_lo, 0);",
  "        // cur_lo, cur_hi = segments[i][1], segments[i][2]",
  "        auto bwd_lo = max(bwd_lo, cur_lo);",
  "        auto bwd_hi = min(bwd_hi, cur_hi);",
  "",
  "    cout << bwd_lo, bwd_hi << \"\\n\";",
  "    cout << fwd_lo, fwd_hi << \"\\n\";",
  "",
...
export function MeasTrafficProgressiveCode({ E, lang = "py", sections }) {

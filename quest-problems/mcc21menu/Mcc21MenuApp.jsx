...
export default function Mcc21MenuApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc21MenuCh2(false));
  ...
  const makers  = { 0: makeMcc21MenuCh1, 1: makeMcc21MenuCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udccb"} Smallest Menu Ever</h1>
      ...
      {step.narr && <Narration key={`m21mn-${tab}-${cur}-${lang}`} text={step.narr} />}

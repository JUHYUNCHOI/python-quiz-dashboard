...
export default function SumKApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSumKCh2(false));
  ...
  const makers  = { 0: makeSumKCh1, 1: makeSumKCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u2211"} {"Sum^K"}</h1>
      ...
      {step.narr && <Narration key={`sk-${tab}-${cur}-${lang}`} text={step.narr} />}

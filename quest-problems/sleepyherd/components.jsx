...
const FULL_CPP = [
  ...
  "    cin.tie(nullptr);",
  "",
  "    auto positions = sorted([int(input()) for _ in range(3)]);",
  "    // a, b, c = positions",
  "",
  "    // Gap between first two and last two",
  "    auto gap1 = b - a  # gap between a and b;",
  "    auto gap2 = c - b  # gap between b and c;",
  "",
  "    // --- Maximum moves ---",
  "    // Move the closer endpoint one step at a time",
  "    // Max = (gap1 - 1) + (gap2 - 1) = total_span - 2",
  "    auto max_moves = (c - a) - 2;",
  "",
  "    // --- Minimum moves ---",
  "    if (gap1 == 1 and gap2 == 1) {",
  "        // Already consecutive",
  "        auto min_moves = 0;",
  "    else if (gap1 <= 2 or gap2 <= 2) {",
  "        // One gap is 1 or 2: can solve in 1 move",
  "        auto min_moves = 1;",
  "    else {",
  "        // Both gaps > 2: need 2 moves",
...
export function SleepyHerdProgressiveCode({ E, lang = "py", sections }) {

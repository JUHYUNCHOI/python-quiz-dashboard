// 🔒 USACO_VERIFIED — cpid=713, crossroad3/cowqueue (2017 Feb Bronze #3)
...
const FULL_PY = [
  ...
  "pairs = []",
  "for i in range(N):",
  "    pairs.append((arrivals[i], durations[i]))",
  "pairs.sort()",
  "",
  "current_time = 0",
  "for i in range(N):",
...
const FULL_CPP = [
  ...
  "        if (current_time < arrival) current_time = arrival;",
  "        current_time += duration;",
  "    }",
  "    fout << current_time << \"\\n\";",
  "    return 0;",

...
export default function RevEngApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeRevEngCh2(false));
  ...
  const makers  = { 0: makeRevEngCh1, 1: makeRevEngCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd27"} Reverse Engineering</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`re-${tab}-${cur}-${lang}`} text={step.narr} />}

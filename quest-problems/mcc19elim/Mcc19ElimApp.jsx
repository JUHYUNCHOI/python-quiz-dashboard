...
export default function Mcc19ElimApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMcc19ElimCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMcc19ElimCh2(false, "py"));

  useEffect(() => {
    setCh2Q(prev => makeMcc19ElimCh2(E, codeLang).map((s, i) => ({ ...s, answered: prev[i]?.answered, solved: prev[i]?.solved })));
  }, [codeLang, E]);
  ...
  const makers  = { 0: makeMcc19ElimCh1, 1: (e) => makeMcc19ElimCh2(e, codeLang) };
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12, alignItems: "center" }}>
          ...
          {showCodeControls && (
            <div style={{ display: "flex", gap: 0, alignItems: "stretch", flexShrink: 0 }}>
              ...
              <button onClick={() => downloadMcc19ElimPDF(E, getMcc19ElimSections(E), codeLang)} style={{

...
>
> 목록의 주인은 **project-lead** 다. 결정 절차는 `.claude/skills/decide/SKILL.md`.
...
| 무엇 | 담당 | 끝났다고 보는 기준 | 상태 |
|---|---|---|---|
| 레슨 32 ch1 — 함수 첫 도입인데 `def` 를 한 번도 안 쳐봄 (32.4%) | lesson-content-reviewer → frontend-engineer | `python3 scripts/check-active-ratio.py 32` 가 50%+ | 대기 |

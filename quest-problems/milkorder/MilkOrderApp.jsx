...
export default function MilkOrderApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMilkOrderCh2(false));
  ...
  const makers  = { 0: makeMilkOrderCh1, 1: makeMilkOrderCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udc04"} Milking Order</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`mo2-${tab}-${cur}-${lang}`} text={step.narr} />}

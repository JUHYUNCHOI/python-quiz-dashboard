...
export default function Mcc19CandyApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc19CandyCh2(false));
  ...
  const makers  = { 0: makeMcc19CandyCh1, 1: makeMcc19CandyCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udf6c"} Candy</h1>
      ...
      {step.narr && <Narration key={`m19c-${tab}-${cur}-${lang}`} text={step.narr} />}

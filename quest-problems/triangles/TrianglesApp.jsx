...
export default function TrianglesApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeTrianglesCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeTrianglesCh2(false, "py"));
  ...
  return (
    <div>
      <div style={{ maxWidth: "min(1300px, 100%)", margin: "0 auto", padding: "0 12px" }}>
        ...
        {step.narr && <Narration key={`tri-${tab}-${cur}-${lang}`} text={step.narr} />}

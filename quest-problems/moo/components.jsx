  ...
  return [
    ...
    },
    {
      ...
      why: [
        ...
        t(E, "For N=20,000 → ~10¹⁰ ops → TLE. Next section optimizes this.",
            "N=20,000 → ~10¹⁰ 연산 → TLE. 다음 섹션에서 최적화."),
      ],
    },
    {
  ...
  return [
    ...
    },
    {
      ...
      why: [
        ...
        t(E, "Total work: N × 26 × 3 = 78N. Versus 26N² brute force → ~6,667× faster at N=20,000.",
            "총 연산: N × 26 × 3 = 78N. 브루트포스 26N² 대비 ~6,667 배 빠름 (N=20,000)."),
      ],
      pyOnly: [

...
export default function SleepySortApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSleepySortCh2(false));
  ...
  const makers  = { 0: makeSleepySortCh1, 1: makeSleepySortCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"😴"} Sleepy Cow Sorting</h1>
      ...
      {step.narr && <Narration key={`ss2-${tab}-${cur}-${lang}`} text={step.narr} />}

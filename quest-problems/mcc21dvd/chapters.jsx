  ...
  return [
    {
      type: "reveal",
      narr: t(E,
        "A DVD logo bounces around a screen. Simulate its position after T steps. The logo bounces off walls by reversing direction.",
        "DVD 로고가 화면에서 튕겨다녀. T번 이동 후 위치를 시뮬레이션해. 벽에 부딪히면 방향이 반전돼."),
      content: (
    ...
    },
    {
      type: "quiz",
      narr: t(E,
        "Screen 10x10, logo at (0,0) moving right-down. After 1 step, where is it?",
        "화면 10x10, 로고 (0,0)에서 오른쪽-아래로 이동. 1단계 후 어디에 있어?"),
      question: t(E,
    ...
    },
    {
      type: "input",
      narr: t(E,
        "If no walls are hit, after 5 steps from (0,0) going (1,1), what is the x-coordinate?",
        "벽에 안 부딪히면, (0,0)에서 (1,1) 방향으로 5단계 후 x좌표는?"),
      question: t(E,
  ...
  return [
    {
      type: "reveal",
      narr: t(E,
        "Simulate each step. Check wall collisions and reverse direction. O(T) time.",
        "각 단계를 시뮬레이션해. 벽 충돌 확인하고 방향 반전. O(T) 시간."),
      content: (
        <div style={{ padding: 16, textAlign: "center" }}>

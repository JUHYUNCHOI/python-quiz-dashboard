...
export default function TeleportApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeTeleportCh1(lang === "en"));
  const [ch2Q, setCh2Q] = useState(() => makeTeleportCh2(lang === "en", "py"));
  ...
  return (
    <div>
      <div style={{ maxWidth: "min(880px, 100%)", margin: "0 auto", padding: "0 clamp(4px, 2vw, 16px)" }}>
        ...
        {step.narr && <Narration key={`tele-${tab}-${cur}-${lang}`} text={step.narr} />}

...
\`\`\``
        ...
        },
        {
          ...
          initialCode: "# 메뉴를 한 줄씩 출력해요. 이름은 왼쪽 12칸, 가격은 오른쪽 8칸 + 쉼표\nprint(f'{\"아메리카노\":<12} {4500:___}원')\nprint(f'{\"카페라떼\":<12} {5000:___}원')\nprint(f'{\"초코케이크\":<12} {6500:___}원')\n\ntotal = 4500 + 5000 + 6500\nprint(f'{\"합계\":<12} {total:>8,}원')",
          expectedOutput: "아메리카노           4,500원\n카페라떼            5,000원\n초코케이크           6,500원\n합계             16,000원",
          hint: "가격 칸은 오른쪽 정렬 8칸 + 쉼표 = `:>8,`.",
          hint2: "f'{\"아메리카노\":<12} {4500:>8,}원'"
        },
        {
          id: "mission1",
          type: "mission",

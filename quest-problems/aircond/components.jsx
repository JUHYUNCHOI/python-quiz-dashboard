...
const FULL_CPP = [
  ...
  "    // for mask in range(1 << M):",
  "        auto total_cost = 0;",
  "        auto cooling = [0] * 101  # cooling at each stall;",
  "        for (long long j = 0; j < M; j++) {",
  "            if (mask & (1 << j)) {",
  "                // s, e, p, cost = acs[j]",
  "                total_cost += cost;",
  "                for (long long pos = s; pos < e + 1; pos++) {",
  "                    // cooling[pos] += p",
  "        // Check if all cows satisfied",
  "        auto ok = True;",
  "        // for s, e, c in cows:",
...
export function AirCondProgressiveCode({ E, lang = "py", sections }) {

...
const FULL_CPP = [
  ...
  "    vector<long long> vals; { long long _x; while (cin >> _x) vals.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "",
  "    // Sort values in descending order",
  "    // vals.sort(reverse=True)",
  "",
...
export function MagicOrbsProgressiveCode({ E, lang = "py", sections }) {

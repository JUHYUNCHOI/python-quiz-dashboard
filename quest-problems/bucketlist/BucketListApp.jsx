...
export default function BucketListApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeBucketListCh2(false));
  ...
  const makers  = { 0: makeBucketListCh1, 1: makeBucketListCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"🪣"} The Bucket List</h1>
      ...
      {step.narr && <Narration key={`bl2-${tab}-${cur}-${lang}`} text={step.narr} />}

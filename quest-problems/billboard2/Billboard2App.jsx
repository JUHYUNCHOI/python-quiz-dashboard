...
export default function Billboard2App(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeBillboard2Ch1(false));
  const [ch2Q, setCh2Q] = useState(() => makeBillboard2Ch2(false, "py"));

  useEffect(() => {
    setCh2Q(prev => makeBillboard2Ch2(E, codeLang).map((s, i) => ({ ...s, answered: prev[i]?.answered, solved: prev[i]?.solved })));
  }, [codeLang, E]);
  ...
  const makers  = { 0: makeBillboard2Ch1, 1: (e) => makeBillboard2Ch2(e, codeLang) };
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12, alignItems: "center" }}>
          ...
          {showCodeControls && (
            <div style={{ display: "flex", gap: 0, alignItems: "stretch", flexShrink: 0 }}>
              ...
              <button onClick={() => downloadBillboard2PDF(E, getBillboard2Sections(E), codeLang)} style={{

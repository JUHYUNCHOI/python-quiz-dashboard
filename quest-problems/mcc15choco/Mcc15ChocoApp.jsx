...
export default function Mcc15ChocoApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc15ChocoCh2(false));
  ...
  const makers  = { 0: makeMcc15ChocoCh1, 1: makeMcc15ChocoCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udf6b"} Chocolate Bars</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`mc15c-${tab}-${cur}-${lang}`} text={step.narr} />}

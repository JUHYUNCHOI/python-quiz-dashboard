...
export default function DontBeLastApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeDontBeLastCh2(false));
  ...
  const makers  = { 0: makeDontBeLastCh1, 1: makeDontBeLastCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udd5b"} Don't Be Last!</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`dbl-${tab}-${cur}-${lang}`} text={step.narr} />}

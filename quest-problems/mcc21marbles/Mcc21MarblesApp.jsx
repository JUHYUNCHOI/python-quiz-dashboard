...
export default function Mcc21MarblesApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc21MarblesCh2(false));
  ...
  const makers  = { 0: makeMcc21MarblesCh1, 1: makeMcc21MarblesCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd34"} Marbles and Boxes</h1>
      ...
      {step.narr && <Narration key={`m21mb-${tab}-${cur}-${lang}`} text={step.narr} />}

...
const FULL_CPP = [
  ...
  "",
  "    // Player 1 picks first (even index), Player 2 picks odd",
  ...
  return [
    {
      ...
      why: [
        ...
        t(E, "The C++ mirrors the Python line by line: read N cards, sort descending, then sum the even-index cards for Player 1.",
            "C++ 는 Python 을 한 줄씩 그대로 옮긴 거예요: 카드 N 장 읽고, 내림차순 정렬, 짝수 인덱스 카드를 더해 플레이어 1 점수."),
      ],
      pyOnly: [

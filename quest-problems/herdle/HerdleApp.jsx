...
export default function HerdleApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeHerdleCh2(false));
  ...
  const makers  = { 0: makeHerdleCh1, 1: makeHerdleCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udfe9"} Herdle</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`hd-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function Mcc21CarrotsApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc21CarrotsCh2(false));
  ...
  const makers  = { 0: makeMcc21CarrotsCh1, 1: makeMcc21CarrotsCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udd55"} Carrots</h1>
      ...
      {step.narr && <Narration key={`m21ca-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function Mcc22CardSharkApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMcc22CardSharkCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMcc22CardSharkCh2(false, "py"));

  useEffect(() => {
    setCh2Q(prev => makeMcc22CardSharkCh2(E, codeLang).map((s, i) => ({ ...s, answered: prev[i]?.answered, solved: prev[i]?.solved })));
  }, [codeLang, E]);
  ...
  const makers  = { 0: makeMcc22CardSharkCh1, 1: (e) => makeMcc22CardSharkCh2(e, codeLang) };
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12, alignItems: "center" }}>
          ...
          {showCodeControls && (
            <div style={{ display: "flex", gap: 0, alignItems: "stretch", flexShrink: 0 }}>
              ...
              <button onClick={() => downloadMcc22CardSharkPDF(E, getMcc22CardSharkSections(E), codeLang)} style={{

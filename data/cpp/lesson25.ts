...
위 함수들 (\`binary_search\`, \`lower_bound\` …) 이 결과를 좀 낯선 형태로 돌려줘요 — **숫자 (인덱스) 가 아니라 "위치를 가리키는 손가락"**. 그 손가락을 **이터레이터 (iterator)** 라고 불러요.

이름 무섭게 들리지만 별 거 아니에요. 다음 페이지에서 1분만 친해지고 본격적으로 함수 배우러 가요!`
        },
        {
          id: "s23-ch2-iter",
          type: "explain",

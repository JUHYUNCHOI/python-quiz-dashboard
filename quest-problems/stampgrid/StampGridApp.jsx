...
const A = "#059669";
export default function StampGridApp() {
  const [lang, setLang] = useState("ko"); const E = lang === "en"; const [tab, setTab] = useState(0); const [si, setSi] = useState(0);
  const [ch1Q, setCh1Q] = useState(() => makeStampCh1(false)); const [ch2Q, setCh2Q] = useState(() => makeStampCh2(false));
  const TABS = E ? ["\ud83d\udccb Problem", "\u26a1 Code"] : ["\ud83d\udccb \ubb38\uc81c", "\u26a1 \ucf54\ub4dc"];
  const setters = { 0: setCh1Q, 1: setCh2Q }, states = { 0: ch1Q, 1: ch2Q }, makers = { 0: makeStampCh1, 1: makeStampCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcee"} Stamp Grid</h1>
      ...
      {step.narr && <Narration key={`sg-${tab}-${cur}-${lang}`} text={step.narr} />}

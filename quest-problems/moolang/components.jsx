...
const FULL_CPP = [
  ...
  "    long long best = 0;",
  "    for (long long t2 = 0; t2 <= min(m, n / 2); t2++) {",
  "        long long nounsLeft = n - 2 * t2;",
  "        long long t1 = min(k, nounsLeft);",
  "        best = max(best, t2 * 3 + t1 * 2);",
  "    }",
  "    cout << best << \"\n\";",
  "    return 0;",
  "}",
...
export function MooLangProgressiveCode({ E, lang = "py", sections }) {

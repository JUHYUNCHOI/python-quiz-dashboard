...
import { downloadMeasTrafficPDF, getMeasTrafficSections, getMeasTrafficWalk } from "./components";
...
export default function MeasTrafficApp(props = {}) {
  ...
  const renderContent = () => {
    ...
    if (step.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getMeasTrafficWalk(E, codeLang)} accent={A} />;
    return null;
  };
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getMeasTrafficWalk(E, codeLang)} accent={A} />;
    return null;
  };

...
const FULL_CPP = [
  ...
  "",
  "    long long N; cin >> N;",
  "    vector<long long> shuffle; { long long _x; while (cin >> _x) shuffle.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "    // Convert to 0-indexed",
  "    auto shuffle = [s - 1 for s in shuffle];",
  "",
  "    vector<long long> cows; { long long _x; while (cin >> _x) cows.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "",
  "    // Build inverse permutation",
  "    auto inv = [0] * N;",
...
export function BovShuffleProgressiveCode({ E, lang = "py", sections }) {

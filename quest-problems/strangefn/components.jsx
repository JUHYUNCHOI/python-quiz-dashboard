...
const FULL_CPP = [
  ...
  "        for (char c : s) if (c != '0' && c != '1') { needBinarize = true; break; }",
  "        if (needBinarize) {",
  "            for (char& c : s) c = ((c - '0') % 2) ? '1' : '0';",
  "            ops = 1;",
  "        }",
  "",
  "        // Step 2: read s as a binary number n mod MOD.",
  "        long long n = 0;",
  "        for (char c : s) n = (n * 2 + (c - '0')) % MOD;",
  "",
  ...
  return [
    {
      ...
      cppOnly: [
        ...
        t(E, "ios::sync_with_stdio(false) + cin.tie(nullptr) speeds up I/O for T up to 10⁵.",
            "T 가 최대 10⁵ 라 ios::sync_with_stdio(false) + cin.tie(nullptr) 로 입출력 가속."),
      ],
    },
  ];
}

...
export default function FamilyTreeApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeFamilyTreeCh2(false));
  ...
  const makers  = { 0: makeFamilyTreeCh1, 1: makeFamilyTreeCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udf33"} Family Tree</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`ft-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function SleepyHerdApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSleepyHerdCh2(false));
  ...
  const makers  = { 0: makeSleepyHerdCh1, 1: makeSleepyHerdCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\ude34"} Sleepy Cow Herding</h1>
      ...
      {step.narr && <Narration key={`sh-${tab}-${cur}-${lang}`} text={step.narr} />}

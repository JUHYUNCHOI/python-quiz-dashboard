...
export default function TrainsApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeTrainsCh2(false));
  ...
  const makers  = { 0: makeTrainsCh1, 1: makeTrainsCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\ude82"} Trains</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`tr-${tab}-${cur}-${lang}`} text={step.narr} />}

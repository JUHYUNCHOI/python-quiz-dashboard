// 🔒 USACO_VERIFIED — cpid=663, sqpasture (2016 Dec Bronze #1)
...
const FULL_CPP = [
  ...
  "    fin >> x1 >> y1 >> x2 >> y2;",
  "    fin >> x3 >> y3 >> x4 >> y4;",
  "    long long min_x = x1 < x3 ? x1 : x3;",
  "    long long max_x = x2 > x4 ? x2 : x4;",
  "    long long min_y = y1 < y3 ? y1 : y3;",
  "    long long max_y = y2 > y4 ? y2 : y4;",

...
const FULL_CPP = [
  ...
  "        for (int r = 0; r < 3; r++) for (int c = 0; c < 3; c++) cin >> ans[r][c];",
  "        for (int r = 0; r < 3; r++) for (int c = 0; c < 3; c++) cin >> gue[r][c];",
  "",
  "        int green = 0, yellow = 0;",
  "        map<string,int> remA, remG;",
  "        for (int r = 0; r < 3; r++) {",
  "            for (int c = 0; c < 3; c++) {",
  "                if (ans[r][c] == gue[r][c]) green++;",
  "                else { remA[ans[r][c]]++; remG[gue[r][c]]++; }",
  "            }",
  "        }",
  "        for (auto& [breed, cnt] : remG) {",
  "            if (remA.count(breed)) yellow += min(cnt, remA[breed]);",
  "        }",
  "        cout << green << \"\n\" << yellow << \"\n\";",
  "    }",
  "    return 0;",
...
export function HerdleProgressiveCode({ E, lang = "py", sections }) {

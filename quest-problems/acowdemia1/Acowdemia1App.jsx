...
export default function Acowdemia1App(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeAcow1Ch2(false));
  ...
  const makers  = { 0: makeAcow1Ch1, 1: makeAcow1Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcda"} Acowdemia I</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`a1-${tab}-${cur}-${lang}`} text={step.narr} />}

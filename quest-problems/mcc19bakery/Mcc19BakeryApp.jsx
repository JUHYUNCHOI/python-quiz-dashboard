...
import { downloadMcc19BakeryPDF, getMcc19BakerySections, getMcc19BakeryWalk } from "./components";
...
export default function Mcc19BakeryApp(props = {}) {
  ...
  const renderContent = () => {
    ...
    if (step.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getMcc19BakeryWalk(E)} accent={A} />;
    return null;
  };
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getMcc19BakeryWalk(E)} accent={A} />;
    return null;
  };

...
지금은 **"아, 주소 기반 트릭이구나"** 정도만 느끼면 충분해요. 진짜 포인터 연산은 **cpp-13 (포인터 기초)** 에서 자세히 배워요.
{/expand}
...
💡 **내림차순**, **구조체 정렬**, 정렬 알고리즘 내부 원리는 cpp-23 (sort 마스터) 에서 자세히 배워요. 여기선 "쓸 수 있다" 만 익히면 충분.`
        },
        {
          id: "ch2-pred-sort",
          type: "predict" as const,
...
이런 **절대 안 변하는 개수**는 vector보다 배열이 짧고 깔끔해요. (cpp-21에서 배우는 **2차원 배열**도 체스판(8×8) 같은 고정 크기 상황에서 요긴해요.)

...
const FULL_CPP = [
  ...
  "",
  "    // BFS from lake to barn, avoiding rock",
  "    auto visited = [[False]*10 for _ in range(10)];",
  "    // visited[lake[0]][lake[1]] = True",
  "    auto q = deque([(lake[0], lake[1], 0)]);",
  "",
  "    while (q) {",
  "        // r, c, d = q.popleft()",
  "        if ((r, c) == barn) {",
...
export function BucketBrigadeProgressiveCode({ E, lang = "py", sections }) {

...
export function makeMadSciCh2(E, lang = "py") {
  return [
    // 2-1: Complexity reveal
    {
      type: "reveal",
      narr: t(E,
        "Just scan once and count contiguous differing blocks. O(N) time!", "한 번 스캔해서 연속 차이 블록을 세면 돼. O(N) 시간!"),
      content: (
        <div style={{ padding: 16, textAlign: "center" }}>

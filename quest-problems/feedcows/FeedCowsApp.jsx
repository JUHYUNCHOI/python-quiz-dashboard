...
export default function FeedCowsApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeFeedCh2(false));
  ...
  const makers  = { 0: makeFeedCh1, 1: makeFeedCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udf3e"} Feeding the Cows</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`fc-${tab}-${cur}-${lang}`} text={step.narr} />}

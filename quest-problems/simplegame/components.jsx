...
export function getSimpleGameWalk(E, lang = "py") {
  ...
  return {
    code: FULL_PY, vars: _SG_VARS, beats: [
      ...
      { hi: [15, 16], bubble: t(E,
        "Line them up: bigger a+b first. Who gets a pair swings the answer by a+b, so take the widest swing first. The minus sign in the key makes it descending.",
        "줄을 세워요. a+b 가 큰 쌍이 먼저예요.\n쌍 하나가 누구 손에 가느냐로 a+b 만큼 갈리니까,\n갈리는 폭이 큰 쌍부터 가져가는 거예요.\n앞의 빼기 기호가 '큰 것부터' 로 뒤집어 줘요.") },
      { hi: [18, 24], bubble: t(E,
        "Walk down the line. t is the turn number: 0, 2, 4 … is Evirir so we add a; 1, 3, 5 … is Rhae so we subtract b.",

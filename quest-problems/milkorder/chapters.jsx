  ...
  return [
    ...
    // 1-2: Quiz
    {
      ...
      explain: t(E,
        ...
        "제약이 없으면, 소 1번이 첫 번째로 갈 수 있어! 1번 위치."),
    },
    // 1-3: Input
    {
      type: "input",
      ...
      hint: t(E,
        ...
        "순서나 고정 위치 제약 없이, 소 1번은 첫 번째가 될 수 있어."),
      answer: 1,
    },
  ];
}
...
/* ═══════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════ */
export function makeMilkOrderCh2(E) {
  return [
        ...
        <div style={{ padding: 16, textAlign: "center" }}>
          ...
          <div style={{ marginTop: 12, background: "#eff6ff", border: "2px solid #93c5fd", borderRadius: 12, padding: 12, fontSize: 13, color: C.text, lineHeight: 1.8 }}>
            {t(E,
              ...
              "최소 힙 위상 정렬로 소 1번(가장 작은 ID)이 유효한 순서 중 최대한 앞에 배치돼.")}
          </div>
        </div>),
    },
    // 2-2: Code
    {
      type: "code",
      narr: t(E,
        "Here's the full topological sort solution!",
        "위상 정렬 전체 풀이야!"),

// 🔒 USACO_VERIFIED (2026-09-23 재제출)
//   Python: 12/12 PASS
//   C++:    12/12 PASS
//   ⚠️ 2026-09-25: 여기 **4/12 (WA - algorithm wrong)** 가 그대로 달려 있었다.
//      그건 **2026-09-23 이전의 옛 알고리즘**(연속 1 덩어리 개수만 세는 코드) 점수다.
//      그 코드는 `fedd3df0` 에서 통째로 교체됐고 `ef4d3788` 이 *"오늘 채점기
//      **12/12 만점**을 받았다"* 고 기록했다. **헤더만 안 바뀐 채 남아 있었다.**
//      ⛔ 그 낡은 한 줄 때문에 오늘 *"틀린 알고리즘을 학생이 보고 있다"* 는
//         잘못된 보고가 나갔다. **헤더는 기록이다 — 코드를 고치면 같이 고쳐라.**
//      QA 가 독립 검증했다(2026-09-25): 비트마스크로 감염 전파를 직접 흉내 낸
//      브루트와 **N=1~18 의 모든 이진 문자열 524,286개 전수 대조 — 불일치 0건.**
//      공식 에디토리얼(cpid 1348) 2차 풀이로 교차검증 3000케이스도 0건.
//      파이썬 N=300,000 실측 0.017~0.059초(제한 2초).

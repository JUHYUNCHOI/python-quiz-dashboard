...
export default function AirCondApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeAirCondCh2(false));
  ...
  const makers  = { 0: makeAirCondCh1, 1: makeAirCondCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u2744\ufe0f"} Air Cownditioning II</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`ac-${tab}-${cur}-${lang}`} text={step.narr} />}

...
const FULL_CPP = [
  ...
  "    // changes.sort()",
  "",
  "    auto get_leaders = [&](m) {   // TODO: type args",
  "        auto mx = max(m.values());",
  "        return frozenset(c for c, v in m.items() if v == mx);",
  "",
  "    auto display_changes = 0;",
  "    auto prev_leaders = get_leaders(milk);",
  "",
  "    // for day, cow, delta in changes:",
  "        // milk[cow] += delta",
  "        auto cur_leaders = get_leaders(milk);",
  "        if (cur_leaders != prev_leaders) {",
  "            display_changes += 1;",
  "        auto prev_leaders = cur_leaders;",
  "",

...
const FULL_CPP = [
  ...
  "    auto ops = ['+', '-', '*', '/'];",
  "",
  "    auto evaluate = [&](a, b, c, op1, op2) {   // TODO: type args",
  "        // Build expression and evaluate",
  "        auto expr = f'{a}{op1}{b}{op2}{c}';",
  "        // try:",
...
export function Mcc15EqProgressiveCode({ E, lang = "py", sections }) {

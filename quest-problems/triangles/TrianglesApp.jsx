...
export default function TrianglesApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeTrianglesCh2(false));
  ...
  const makers  = { 0: makeTrianglesCh1, 1: makeTrianglesCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcd0"} Triangles</h1>

...
export default function CowTipApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeCowTipCh2(false));
  ...
  const makers  = { 0: makeCowTipCh1, 1: makeCowTipCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udc04"} Cow Tipping</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`ct3-${tab}-${cur}-${lang}`} text={step.narr} />}

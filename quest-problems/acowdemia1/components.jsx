...
const FULL_CPP = [
  ...
  "    auto c = sorted(map(int, input().split()));",
  "",
  "    auto check = [&](h) {   // TODO: type args",
  "        // count papers with >= h citations",
  "        // papers are sorted ascending",
  "        auto idx = N - h  # need last h papers;",
  "        // if idx < 0: return False",
  "        auto need = 0;",
...
export function Acowdemia1ProgressiveCode({ E, lang = "py", sections }) {

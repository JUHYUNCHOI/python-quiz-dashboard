...
export default function GuessAnimalApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeGuessAnimalCh2(false));
  ...
  const makers  = { 0: makeGuessAnimalCh1, 1: makeGuessAnimalCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"🐾"} Guess the Animal</h1>
      ...
      {step.narr && <Narration key={`ga-${tab}-${cur}-${lang}`} text={step.narr} />}

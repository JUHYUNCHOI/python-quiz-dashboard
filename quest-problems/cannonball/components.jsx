...
const FULL_CPP = [
  ...
  "    auto pos_type = {}  # position -> (type, value);",
  "    for (long long _ = 0; _ < N; _++) {",
  "        // p, typ, val = map(int, input().split())",
  "        // pos_type[p] = (typ, val)",
  "",
  "    auto position = S;",
  "    auto direction = 1   # 1 = right, -1 = left;",
  "    auto power = 1;",
  "    auto broken = set();",
  "    auto visited = set();",
  "",
  "    while (True) {",
  "        auto state = (position, direction, power);",
  "        if (state in visited) {",
  "            break;",
  "        // visited.add(state)",
  "",
...
export function CannonballProgressiveCode({ E, lang = "py", sections }) {

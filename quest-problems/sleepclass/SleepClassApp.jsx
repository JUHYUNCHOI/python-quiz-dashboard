...
export default function SleepClassApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSleepCh2(false));
  ...
  const makers  = { 0: makeSleepCh1, 1: makeSleepCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\ude34"} Sleeping in Class</h1>
      ...
      {step.narr && <Narration key={`sl-${tab}-${cur}-${lang}`} text={step.narr} />}

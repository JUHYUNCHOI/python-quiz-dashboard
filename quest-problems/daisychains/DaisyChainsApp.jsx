...
export default function DaisyChainsApp(props = {}) {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeDaisyCh3(false));
  ...
  const makers  = { 0: makeDaisyCh1, 1: makeDaisyCh2, 2: makeDaisyCh3 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\uD83C\uDF3C"} Daisy Chains</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`dc-${tab}-${cur}-${lang}`} text={step.narr} />}

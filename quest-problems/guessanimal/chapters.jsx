...
export function makeGuessAnimalCh1(E) {
  return [
    // 1-1: Title reveal
    {
      type: "reveal",
      narr: t(E,
        "Bessie is thinking of one animal — find the worst-case 'yes' count.",
        "Bessie가 동물 하나를 생각해요 — 최악의 '예' 답변 수를 구해요."),
      content: (
    ...
    // 1-2: Quiz
    {
      type: "quiz",
      narr: t(E,
        "Count how many traits the two animals share.",
        "두 동물의 공통 특성이 몇 개인지 세어봐요."),
      question: t(E,
    ...
    // 1-3: Pairwise trait intersection sim
    {
      type: "reveal",
      narr: t(E,
        "Pick two animals and see which traits they share.",
        "두 동물을 골라 공통 특성을 확인해봐요."),
      content: (

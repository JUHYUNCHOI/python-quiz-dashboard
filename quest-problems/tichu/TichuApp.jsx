...
export default function TichuApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeTichuCh2(false));
  ...
  const makers  = { 0: makeTichuCh1, 1: makeTichuCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udccf"} Tichu</h1>
      ...
      {step.narr && <Narration key={`ti-${tab}-${cur}-${lang}`} text={step.narr} />}

...
const FULL_CPP = [
  ...
  "        vector<long long> line; { long long _x; while (cin >> _x) line.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "        auto target = line[0];",
  "        auto ingredients = line[1:];",
  "        // recipes[target] = ingredients",
  "",
  "    // Greedy: try to make metal N from top down",
  "    auto make = [&](metal) {   // TODO: type args",
  "        if (count[metal] > 0) {",
  "            // count[metal] -= 1",
  "            return True;",
  "        if (metal not in recipes) {",
...
export function AlchemyProgressiveCode({ E, lang = "py", sections }) {

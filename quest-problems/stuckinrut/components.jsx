...
const FULL_CPP = [
  ...
  "                continue;",
  "            }",
  "            long long nx = cows[i].x;",
  "            long long ny = cows[i].y;",
  "            long long ex = cows[j].x;",
  "            long long ey = cows[j].y;",
  ...
  "                if (tN > tE) {",
  "                    events.push_back({tN, i, j, tE});",
  "                } else if (tE > tN) {",
  "                    events.push_back({tE, j, i, tN});",
  "                }",
  "                // equal: they share the cell, neither stops",
  "            }",
  "        }",
  ...
  "        if (cows[e.victim].stopTime != -1) {",
  "            continue;   // victim already stopped",
  "        }",
  "        if (cows[e.blocker].stopTime != -1 &&",
  "            cows[e.blocker].stopTime < e.blockerArrive) {",
  "            continue;",
  "        }",
  ...
  "",
  "    for (int i = 0; i < N; i++) {",
  "        if (cows[i].stopTime == -1) {",
  "            cout << \"Infinity\\n\";",
  "        } else {",
  "            cout << cows[i].stopTime << \"\\n\";",
  "        }",
  "    }",
  "    return 0;",
  "}",

...
export default function CannonballApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeCannonCh2(false));
  ...
  const makers  = { 0: makeCannonCh1, 1: makeCannonCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udca5"} Cannonball</h1>

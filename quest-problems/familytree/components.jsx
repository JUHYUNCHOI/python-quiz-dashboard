...
const FULL_CPP = [
  ...
  "    while (cur) {",
  "        if (cur in ancestors_A) {",
  "            auto depth_A = ancestors_A[cur];",
  "            if (depth_A == 0 and depth_B > 0) {",
  "                auto rel = 'the mother' if depth_B == 1 else 'an ancestor';",
  "                cout << f'{A} is {rel} of {B}' << \"\\n\";",
  "            else if (depth_B == 0 and depth_A > 0) {",
  "                auto rel = 'the child' if depth_A == 1 else 'a descendant';",
  "                cout << f'{A} is {rel} of {B}' << \"\\n\";",
  "            else if (depth_A > 0 and depth_B > 0) {",
  "                cout << f'{A} and {B} are related through a common ancestor' << \"\\n\";",
  "                // could be siblings or cousins",
  "            else {",
  "                cout << f'{A} and {B} are the same cow' << \"\\n\";",
  "            break;",
  "        auto cur = parent.get(cur);",
  "        depth_B += 1;",
  "    else {",
  "        cout << f'{A} and {B} are not related' << \"\\n\";",
  "",
  "    return 0;",
  "}",
];
...
export function FamilyTreeProgressiveCode({ E, lang = "py", sections }) {

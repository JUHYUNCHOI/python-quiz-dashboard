...
//   Python: 0/1 (RTE - wrong input parsing (missing T))
//   C++:    0/1 (WA - missing T (test cases) handling)
  ...
  return [
    {
      ...
      cppOnly: [
        ...
        t(E, "Track lastG and lastH separately so each patch covers K positions.",
            "lastG, lastH를 따로 추적해서 패치 하나가 K칸을 덮도록 함."),
      ],
    },
  ];
}

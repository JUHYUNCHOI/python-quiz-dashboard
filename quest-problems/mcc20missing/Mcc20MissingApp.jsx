...
export default function Mcc20MissingApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc20MissingCh2(false));
  ...
  const makers  = { 0: makeMcc20MissingCh1, 1: makeMcc20MissingCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u2753"} Missing Number</h1>
      ...
      {step.narr && <Narration key={`m20ms-${tab}-${cur}-${lang}`} text={step.narr} />}

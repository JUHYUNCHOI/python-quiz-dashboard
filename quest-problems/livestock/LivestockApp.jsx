...
export default function LivestockApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeLivestockCh2(false));
  ...
  const makers  = { 0: makeLivestockCh1, 1: makeLivestockCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"🐄"} Livestock Lineup</h1>
      ...
      {step.narr && <Narration key={`ll-${tab}-${cur}-${lang}`} text={step.narr} />}

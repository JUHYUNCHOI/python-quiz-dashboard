...
export default function HoofballApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeHoofballCh2(false));
  ...
  const makers  = { 0: makeHoofballCh1, 1: makeHoofballCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u26BD"} Hoofball</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`hb-${tab}-${cur}-${lang}`} text={step.narr} />}

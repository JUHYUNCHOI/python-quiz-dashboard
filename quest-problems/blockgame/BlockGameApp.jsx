...
export default function BlockGameApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeBlockGameCh2(false));
  ...
  const makers  = { 0: makeBlockGameCh1, 1: makeBlockGameCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udde9"} Block Game</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`blg-${tab}-${cur}-${lang}`} text={step.narr} />}

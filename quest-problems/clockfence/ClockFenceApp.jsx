...
export default function ClockFenceApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeClockCh2(false));
  ...
  const makers  = { 0: makeClockCh1, 1: makeClockCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd04"} Clockwise Fence</h1>
      ...
      {step.narr && <Narration key={`cf2-${tab}-${cur}-${lang}`} text={step.narr} />}

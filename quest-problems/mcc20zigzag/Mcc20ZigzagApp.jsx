...
export default function Mcc20ZigzagApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMcc20ZigzagCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMcc20ZigzagCh2(false, "py"));

  useEffect(() => {
    setCh2Q(prev => makeMcc20ZigzagCh2(E, codeLang).map((s, i) => ({ ...s, answered: prev[i]?.answered, solved: prev[i]?.solved })));
  }, [codeLang, E]);
  ...
  const makers  = { 0: makeMcc20ZigzagCh1, 1: (e) => makeMcc20ZigzagCh2(e, codeLang) };
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12, alignItems: "center" }}>
          ...
          {showCodeControls && (
            <div style={{ display: "flex", gap: 0, alignItems: "stretch", flexShrink: 0 }}>
              ...
              <button onClick={() => downloadMcc20ZigzagPDF(E, getMcc20ZigzagSections(E), codeLang)} style={{

...
export default function OutOfPlaceApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeOutOfPlaceCh2(false));
  ...
  const makers  = { 0: makeOutOfPlaceCh1, 1: makeOutOfPlaceCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd00"} Out of Place</h1>
      ...
      {step.narr && <Narration key={`oop-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function BacteriaApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeBacteriaCh2(false));
  ...
  const makers  = { 0: makeBacteriaCh1, 1: makeBacteriaCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udda0"} Balancing Bacteria</h1>

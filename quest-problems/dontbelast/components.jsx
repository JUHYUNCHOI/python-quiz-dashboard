// 🔒 USACO_VERIFIED — cpid=687, dontbelast (2017 Jan Bronze #1, Don't Be Last)
// py 11/11 PASS · cpp 11/11 PASS · 2026-05-14
...
const FULL_PY = [
  ...
  "with open('notlast.in', 'r') as file:",
  ...
  "        answer = 'Tie'",
  "",
  "with open('notlast.out', 'w') as file:",
  "    file.write(answer + '\\n')",
];
...
const FULL_CPP = [
  ...
  "",
  "    vector<string> cows = {\"Bessie\", \"Elsie\", \"Daisy\", \"Gertie\",",
  "                           \"Annabelle\", \"Maggie\", \"Henrietta\"};",
  "    map<string, int> milk;",
  "    for (int i = 0; i < (int)cows.size(); i++) milk[cows[i]] = 0;",
  "    int N;",
  "    fin >> N;",
  "    for (int i = 0; i < N; i++) {",
  "        string name;",
  ...
  "            if (vals[j] == m) { found = true; break; }",
  "        }",
  "        if (!found) vals.push_back(m);",
  "    }",
  ...
  "        for (int i = 0; i < (int)cows.size(); i++) {",
  "            if (milk[cows[i]] == second) winners.push_back(cows[i]);",
  "        }",
  "        if ((int)winners.size() == 1) answer = winners[0];",
  "        else answer = \"Tie\";",
  "    }",
  "    fout << answer << \"\\n\";",
  "    return 0;",

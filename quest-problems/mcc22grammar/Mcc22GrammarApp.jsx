...
export default function Mcc22GrammarApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc22GrammarCh2(false));
  ...
  const makers  = { 0: makeMcc22GrammarCh1, 1: makeMcc22GrammarCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcd6"} Grammar</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`m22g-${tab}-${cur}-${lang}`} text={step.narr} />}

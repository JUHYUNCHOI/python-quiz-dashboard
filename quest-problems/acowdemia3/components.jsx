...
const FULL_CPP = [
  ...
  "",
  "",
  "    auto adj = defaultdict(list)  # grass -> list of adjacent cows;",
  ...
  "    // Max matching: each grass matches at most 1 cow pair",
  "    auto match = {};",
  "    auto dfs = [&](grass, visited) {   // TODO: type args",
  "        // for cow in adj[grass]:",
  "            if (cow not in visited) {",
  "                // visited.add(cow)",
  "                if (cow not in match or dfs(match[cow], visited)) {",
...
export function Acowdemia3ProgressiveCode({ E, lang = "py", sections }) {

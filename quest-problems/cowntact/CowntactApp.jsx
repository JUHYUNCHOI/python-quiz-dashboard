...
export default function CowntactApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeCowntactCh2(false));
  ...
  const makers  = { 0: makeCowntactCh1, 1: makeCowntactCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udda0"} Cowntact Tracing 2</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`ct-${tab}-${cur}-${lang}`} text={step.narr} />}

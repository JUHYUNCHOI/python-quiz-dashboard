...
export default function SimpleGameApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSimpleGameCh2(false));
  ...
  const makers  = { 0: makeSimpleGameCh1, 1: makeSimpleGameCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udfae"} Simple Game</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`sg3-${tab}-${cur}-${lang}`} text={step.narr} />}

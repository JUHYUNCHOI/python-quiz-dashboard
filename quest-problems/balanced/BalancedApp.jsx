...
export default function BalancedApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeBalancedCh1(lang === "en"));
  const [ch2Q, setCh2Q] = useState(() => makeBalancedCh2(lang === "en"));
  const [ch3Q, setCh3Q] = useState(() => makeBalancedCh3(lang === "en", "py"));

...
export default function SocDist1App(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSocDist1Ch2(false));
  ...
  const makers  = { 0: makeSocDist1Ch1, 1: makeSocDist1Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\ude37"} Social Distancing I</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`sd1-${tab}-${cur}-${lang}`} text={step.narr} />}

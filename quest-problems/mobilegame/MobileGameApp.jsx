...
export default function MobileGameApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMobileGameCh2(false));
  ...
  const makers  = { 0: makeMobileGameCh1, 1: makeMobileGameCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcf1"} Mobile Game</h1>
      ...
      {step.narr && <Narration key={`mg-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function Hps17App(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeHps17Ch2(false));
  ...
  const makers  = { 0: makeHps17Ch1, 1: makeHps17Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u270a"} Hoof, Paper, Scissors</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`hp17-${tab}-${cur}-${lang}`} text={step.narr} />}

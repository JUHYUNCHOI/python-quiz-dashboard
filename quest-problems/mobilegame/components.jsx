...
const FULL_CPP = [
  ...
  "",
  "    long long N; cin >> N;",
  "    vector<long long> scores; { long long _x; while (cin >> _x) scores.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "",
  "    // Play all levels, sum all scores",
  "    auto total = sum(scores);",
  "",
  "    cout << total << \"\\n\";",
  "",
  "    return 0;",
...
export function MobileGameProgressiveCode({ E, lang = "py", sections }) {

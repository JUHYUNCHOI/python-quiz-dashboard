...
export default function CowntraceApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeCowntraceCh2(false));
  ...
  const makers  = { 0: makeCowntraceCh1, 1: makeCowntraceCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd0d"} Cowntact Tracing</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`ct2-${tab}-${cur}-${lang}`} text={step.narr} />}

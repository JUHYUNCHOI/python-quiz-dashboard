...
export default function Billboard2App(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeBillboard2Ch2(false));
  ...
  const makers  = { 0: makeBillboard2Ch1, 1: makeBillboard2Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udea7"} Blocked Billboard II</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`bb2-${tab}-${cur}-${lang}`} text={step.narr} />}

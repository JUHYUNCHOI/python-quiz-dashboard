...
export default function WordProcApp(props = {}) {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeWordProcCh3(false));
  ...
  const makers  = { 0: makeWordProcCh1, 1: makeWordProcCh2, 2: makeWordProcCh3 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"📝"} Word Processor</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`wp-${tab}-${cur}-${lang}`} text={step.narr} />}

    ...
    /* 1-1 — Problem statement. */
    {
      ...
      content: (
        <div style={{ padding: 16 }}>
          ...
          <div style={{ background: "#f0f9ff", border: "1px solid #7dd3fc", borderRadius: 12, padding: 14, marginBottom: 10 }}>
...
60`}
          ...
          <div style={{ background: "#f0f9ff", border: "1px solid #7dd3fc", borderRadius: 10, padding: 12, fontSize: 12, color: C.text, lineHeight: 1.7 }}>

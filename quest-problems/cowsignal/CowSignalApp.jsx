...
export default function CowSignalApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeCowSignalCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeCowSignalCh2(false));
  const [ch3Q, setCh3Q] = useState(() => makeCowSignalCh3(false, "py"));

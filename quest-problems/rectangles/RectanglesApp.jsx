...
export default function RectanglesApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeRectanglesCh2(false));
  ...
  const makers  = { 0: makeRectanglesCh1, 1: makeRectanglesCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u25ac"} Rectangles</h1>

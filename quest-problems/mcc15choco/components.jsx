...
const FULL_CPP = [
  ...
  "",
  "    long long N; cin >> N;",
  "    vector<long long> bars; { long long _x; while (cin >> _x) bars.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "",
  "    auto stack = [];",
  "    auto total = 0;",
  "",
...
export function Mcc15ChocoProgressiveCode({ E, lang = "py", sections }) {

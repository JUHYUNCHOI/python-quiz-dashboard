...
export default function Mcc19DitcoinApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc19DitcoinCh2(false));
  ...
  const makers  = { 0: makeMcc19DitcoinCh1, 1: makeMcc19DitcoinCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcb0"} Ditcoin</h1>
      ...
      {step.narr && <Narration key={`m19d-${tab}-${cur}-${lang}`} text={step.narr} />}

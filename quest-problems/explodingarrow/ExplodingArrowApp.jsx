...
export default function ExplodingArrowApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeExplodingArrowCh2(false));
  ...
  const makers  = { 0: makeExplodingArrowCh1, 1: makeExplodingArrowCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udca5"} Exploding Arrow</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`ea-${tab}-${cur}-${lang}`} text={step.narr} />}

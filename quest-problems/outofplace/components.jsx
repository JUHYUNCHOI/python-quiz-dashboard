// 🔒 USACO_VERIFIED — cpid=785, outofplace (2018 Jan Bronze #3)
...
const FULL_PY = [
  ...
  "with open('outofplace.in', 'r') as file:",
  "    lines = file.readlines()",
  "",
  "N = int(lines[0])",
  "a = []",
  "for i in range(N):",
  "    a.append(int(lines[1 + i]))",
  "",
  ...
  "    answer = 0",
  "",
  "with open('outofplace.out', 'w') as file:",
...
export function getOutOfPlaceSections(E) {
  return [
    {
...
export function OutOfPlaceProgressiveCode(props) {

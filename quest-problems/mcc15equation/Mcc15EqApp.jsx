...
export default function Mcc15EqApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc15EqCh2(false));
  ...
  const makers  = { 0: makeMcc15EqCh1, 1: makeMcc15EqCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u2795"} Complete the Equation</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`mc15e-${tab}-${cur}-${lang}`} text={step.narr} />}

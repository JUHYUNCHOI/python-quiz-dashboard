...
export default function WhereAmIApp(props = {}) {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeWhereAmICh3(false));
  ...
  const makers  = { 0: makeWhereAmICh1, 1: makeWhereAmICh2, 2: makeWhereAmICh3 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\uD83D\uDCCD"} Where Am I?</h1>
      ...
      {step.narr && <Narration key={`wa-${tab}-${cur}-${lang}`} text={step.narr} />}

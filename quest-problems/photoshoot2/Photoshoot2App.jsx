...
export default function Photoshoot2App(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makePhoto2Ch2(false));
  ...
  const makers  = { 0: makePhoto2Ch1, 1: makePhoto2Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcf7"} Photoshoot 2</h1>
      ...
      {step.narr && <Narration key={`p2-${tab}-${cur}-${lang}`} text={step.narr} />}

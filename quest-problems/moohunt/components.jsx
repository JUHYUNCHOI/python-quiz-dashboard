...
const FULL_PY = [
  ...
  "",
  "# 같은 무브끼리 묶어요. 무브는 20만 개인데 서로 다른 건 6840개뿐이에요 (20×19×18).",
  "cnt = Counter()",
  "for _ in range(K):",
...
const FULL_CPP = [
  ...
  "    cin >> N >> K;",
  "",
  "    // 같은 무브끼리 묶어요. 무브는 20만 개인데 서로 다른 건 6840개뿐 (20×19×18).",

...
const FULL_CPP = [
  ...
  "            auto arr = [int(x) for x in line[:N]];",
  "            auto out = int(line[N]);",
  "            // inputs.append(tuple(arr))",
  "            // outputs.append(out)",
  "",
  ...
  "                    auto expected = A if inputs[k][pos] == 0 else B;",
  "                    if (expected != outputs[k]) {",
  "                        auto valid = False;",
  "                        break;",
  "                if (valid) {",
  ...
  "            if (all(o == 0 for o in outputs)) {",
  "                auto possible = True;",
  "            else if (all(o == 1 for o in outputs)) {",
  "                auto possible = True;",
  "",
  "        cout << 'OK' if possible else 'LIE' << \"\\n\";",
  "",
  "    return 0;",
  "}",
];
...
export function RevEngProgressiveCode({ E, lang = "py", sections }) {

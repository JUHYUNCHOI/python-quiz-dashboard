...
const FULL_CPP = [
  ...
  "        if (oddsLeft % 2 != 0) {",
  "            continue; // leftover odds pair up",
  "        }",
  "        // each even group needs 1 even OR 2 leftover odds",
  "        if (even + oddsLeft / 2 >= evenGroups) {",
  "            ans = k;",
  "        }",
  "    }",
  "    cout << ans << \"\\n\";",
    ...
    return {
      ...
      beats: [
        ...
        { hi: [19, 24], bubble: t(E,
          ...
          "무엇을 출력해야 하나요? 합이 짝·홀·짝·홀 순서로 번갈아 가는 묶음의 최대 개수예요. 짝수합 묶음은 짝수 소 1마리 또는 홀수 소 2마리, 홀수합 묶음은 홀수 소 1마리면 돼요 — 개수만 알면 충분해요.") },
        { hi: [25, 26], bubble: t(E,

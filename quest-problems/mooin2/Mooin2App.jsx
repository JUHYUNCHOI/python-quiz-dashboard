...
export default function Mooin2App(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMooin2Ch1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMooin2Ch2(false, "py"));
  ...
  return (
    <div>
      <div style={{ maxWidth: "min(880px, 100%)", margin: "0 auto", padding: "0 clamp(4px, 2vw, 16px)" }}>
            ...
            {TABS.map((label, i) => {
              ...
              return (
                <button key={i} onClick={() => changeTab(i)} style={{
                  ...
                  background: isCurrent ? A : (isVisited ? "#ffedd5" : "transparent"),
        ...
        {step.narr && <Narration key={`m2-${tab}-${cur}-${lang}`} text={step.narr} />}

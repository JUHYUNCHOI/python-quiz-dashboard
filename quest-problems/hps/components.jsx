...
const HP_INPUT_CPP = (E) => [
  ...
  "            else if (row[j] == 'L') beats[j][i] = true;",
  "        }",
  "    }",
];
...
/* Brute force full program — the natural first solution. Submit this →
   even C++ TLEs on the bigger test cases (next chapter explains why). */
const HP_BRUTE_PY = [
  "N, M = map(int, input().split())",
  "",
  "beats = [[False] * N for _ in range(N)]",

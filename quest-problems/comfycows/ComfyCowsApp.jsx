...
export default function ComfyCowsApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeComfyCh2(false));
  ...
  const makers  = { 0: makeComfyCh1, 1: makeComfyCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udc04"} Comfortable Cows</h1>
      ...
      {step.narr && <Narration key={`cf-${tab}-${cur}-${lang}`} text={step.narr} />}

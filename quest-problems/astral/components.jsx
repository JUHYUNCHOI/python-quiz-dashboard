...
const AST_S3_CPP = [
  ...
  "                if (visited[r0][c0]) continue;",
  "                if (r0 - B >= 0 && c0 - A >= 0) continue;  // not a chain start",
  "                vector<char> chain;",
  "                int r = r0, c = c0;",
...
const AST_S4_CPP = [
  ...
  "                char c0 = chain[0];",
  "                if (c0 == 'W') state[0] = 0;",
  "                else if (c0 == 'G') { state[0] = 1; state[1] = 1; }",
  "                // 'B' impossible from in=0",
  ...
  "                    } else {  // G",
  "                        if (s0 != INF) { ns[0] = min(ns[0], s0 + 1); ns[1] = min(ns[1], s0 + 1); }",
  "                        if (s1 != INF) { ns[0] = min(ns[0], s1); }",
  "                    }",
  "                    state[0] = ns[0]; state[1] = ns[1];",
  "                }",
];
...
const AST_FULL_CPP = [
  ...
  "                char c0c = chain[0];",
  "                if (c0c == 'W') state[0] = 0;",
  "                else if (c0c == 'G') { state[0] = 1; state[1] = 1; }",
  "",
  "                for (int k = 1; k < (int)chain.size(); k++) {",
  "                    char comp = chain[k];",
  "                    int ns[2] = { INF, INF };",
  ...
  "                if (chain_min == INF) { impossible = true; break; }",
  "                total += chain_min;",
  "            }",
  "        }",
  "",

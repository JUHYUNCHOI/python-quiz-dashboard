...
// 🛠 Fix vs old version: use min(n-3, pos) so we only iterate the (≤3) windows
// that actually contain pos. The old min(n-2, pos+1) overshot by 1 window and
// indexed t[-1] in Python, silently corrupting the trial.

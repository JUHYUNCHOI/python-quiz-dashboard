...
export default function WordProcApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeWordProcCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeWordProcCh2(false));
  const [ch3Q, setCh3Q] = useState(() => makeWordProcCh3(false, "py"));

...
export default function ShellGameApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeShellCh1(lang === "en"));
  const [ch2Q, setCh2Q] = useState(() => makeShellCh2(lang === "en"));
  const [ch3Q, setCh3Q] = useState(() => makeShellCh3(lang === "en", "py"));
  ...
  return (
    <div>
      <div style={{ maxWidth: "min(880px, 100%)", margin: "0 auto", padding: "0 clamp(4px, 2vw, 16px)" }}>
        ...
        {step.narr && <Narration key={`shellgam-${tab}-${cur}-${lang}`} text={step.narr} />}

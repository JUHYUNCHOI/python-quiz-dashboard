...
import { makeMcc21GlassCh1, makeMcc21GlassCh2 } from "./chapters";

const A = "#2563eb";

export default function Mcc21GlassApp() {
  ...
  const makers  = { 0: makeMcc21GlassCh1, 1: makeMcc21GlassCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udd5b"} Round Glass</h1>
      ...
      {step.narr && <Narration key={`m21gl-${tab}-${cur}-${lang}`} text={step.narr} />}

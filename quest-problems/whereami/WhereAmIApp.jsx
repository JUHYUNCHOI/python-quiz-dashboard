...
export default function WhereAmIApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeWhereAmICh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeWhereAmICh2(false));
  const [ch3Q, setCh3Q] = useState(() => makeWhereAmICh3(false, "py"));

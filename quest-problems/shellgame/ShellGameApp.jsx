...
export default function ShellGameApp(props = {}) {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeShellCh3(false));
  ...
  const makers  = { 0: makeShellCh1, 1: makeShellCh2, 2: makeShellCh3 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"🐚"} Shell Game</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`sg2-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function Mcc20ZigzagApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc20ZigzagCh2(false));
  ...
  const makers  = { 0: makeMcc20ZigzagCh1, 1: makeMcc20ZigzagCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u26a1"} Zig-zag</h1>
      ...
      {step.narr && <Narration key={`m20zz-${tab}-${cur}-${lang}`} text={step.narr} />}

...
const FULL_CPP = [
  ...
  "",
  "    // Bounding box of both rectangles",
  "    auto min_x = min(x1, x3);",
  "    auto max_x = max(x2, x4);",
  "    auto min_y = min(y1, y3);",
  "    auto max_y = max(y2, y4);",
  "",
  "    // Square side = max of width and height span",
  "    auto side = max(max_x - min_x, max_y - min_y);",
  "",
  "    cout << side * side << \"\\n\";",
  "",
  "    return 0;",
...
export function SqPastureProgressiveCode({ E, lang = "py", sections }) {

...
const FULL_CPP = [
  ...
  "",
  "    long long N; cin >> N;",
  "    vector<long long> target; { long long _x; while (cin >> _x) target.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
...
export function Photoshoot2ProgressiveCode({ E, lang = "py", sections }) {

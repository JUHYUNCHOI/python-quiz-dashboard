...
import { downloadMcc19CandyPDF, getMcc19CandySections, getMcc19CandyWalk } from "./components";
...
export default function Mcc19CandyApp(props = {}) {
  ...
  const renderContent = () => {
    ...
    if (step.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getMcc19CandyWalk(E)} accent={A} />;
    return null;
  };
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getMcc19CandyWalk(E)} accent={A} />;
    return null;
  };

...
import { downloadHps17PDF, getHps17Sections, getHps17Walk } from "./components";
...
export default function Hps17App(props = {}) {
  ...
  const renderContent = () => {
    ...
    if (step.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getHps17Walk(E, codeLang)} accent={A} />;
    return null;
  };
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getHps17Walk(E, codeLang)} accent={A} />;
    return null;
  };

  ...
  return [
    {
      ...
      why: [
        ...
        t(E, "The answer is just N % K — no loop needed.",
            "답은 N % K 하나면 끝 — 반복문도 필요 없어."),
      ],
      pyOnly: [
        t(E, "map(int, input().split()) reads N and K on one line.",
            "map(int, input().split())로 한 줄의 N, K를 읽어."),
      ],
      cppOnly: [
        t(E, "cin >> N >> K reads both numbers; % gives the remainder.",
            "cin >> N >> K 로 둘 다 읽고, % 로 나머지를 구해."),
      ],
    },
  ];
}

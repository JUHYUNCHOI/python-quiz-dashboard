  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, background: C.bg, padding: "6px 16px 12px", zIndex: 100 }}>
        <div style={{ maxWidth: 440, margin: "0 auto" }}>
          {isBlocked && (
            <div style={{ textAlign: "center", fontSize: 13, color: C.carry, fontWeight: 700, marginBottom: 4 }}>
              {E ? "\ud83d\udc46 Answer first!" : "\ud83d\udc46 \uba3c\uc800 \ub2f5\ud574\ubd10!"}
            </div>
          )}
          <div style={{ display: "flex", gap: 8, justifyContent: "center", alignItems: "center" }}>
            <button onClick={() => { setSi(Math.max(0, cur - 1)); window.scrollTo({ top: 0, behavior: "smooth" }); }} disabled={cur === 0} style={{
            ...
            <button onClick={() => { if (canNext) { setSi(cur + 1); window.scrollTo({ top: 0, behavior: "smooth" }); } }} disabled={!canNext} style={{

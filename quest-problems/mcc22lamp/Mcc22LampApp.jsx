...
export default function Mcc22LampApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMcc22LampCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMcc22LampCh2(false, "py"));

  useEffect(() => {
    setCh2Q(prev => makeMcc22LampCh2(E, codeLang).map((s, i) => ({ ...s, answered: prev[i]?.answered, solved: prev[i]?.solved })));
  }, [codeLang, E]);
  ...
  const makers  = { 0: makeMcc22LampCh1, 1: (e) => makeMcc22LampCh2(e, codeLang) };
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12, alignItems: "center" }}>
          ...
          {showCodeControls && (
            <div style={{ display: "flex", gap: 0, alignItems: "stretch", flexShrink: 0 }}>
              ...
              <button onClick={() => downloadMcc22LampPDF(E, getMcc22LampSections(E), codeLang)} style={{

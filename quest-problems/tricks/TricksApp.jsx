...
export default function TricksApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeTricksCh1(lang === "en"));
  const [ch2Q, setCh2Q] = useState(() => makeTricksCh2(lang === "en"));
  const [ch3Q, setCh3Q] = useState(() => makeTricksCh3(lang === "en"));
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "packTypeClassifier") return <PackTypeClassifier E={E} />;

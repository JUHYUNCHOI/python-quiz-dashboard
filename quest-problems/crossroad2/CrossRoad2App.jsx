...
export default function CrossRoad2App(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeCrossRd2Ch2(false));
  ...
  const makers  = { 0: makeCrossRd2Ch1, 1: makeCrossRd2Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd00"} Cross the Road II</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`cr2-${tab}-${cur}-${lang}`} text={step.narr} />}

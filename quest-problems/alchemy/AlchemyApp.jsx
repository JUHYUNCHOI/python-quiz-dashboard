...
export default function AlchemyApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeAlchemyCh2(false));
  ...
  const makers  = { 0: makeAlchemyCh1, 1: makeAlchemyCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u2697\ufe0f"} Alchemy</h1>

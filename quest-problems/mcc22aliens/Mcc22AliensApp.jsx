...
export default function Mcc22AliensApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc22AliensCh2(false));
  ...
  const makers  = { 0: makeMcc22AliensCh1, 1: makeMcc22AliensCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udc7d"} Aliens</h1>
      ...
      {step.narr && <Narration key={`m22a-${tab}-${cur}-${lang}`} text={step.narr} />}

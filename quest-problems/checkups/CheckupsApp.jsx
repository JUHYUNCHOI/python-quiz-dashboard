...
export default function CheckupsApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeCheckupsCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeCheckupsCh2(false, "py"));
  ...
  return (
    <div>
      <div style={{ maxWidth: "min(1100px, 100%)", margin: "0 auto", padding: "0 12px" }}>
        ...
        {step.narr && <Narration key={`ckp-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function UdderedApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeUdderedCh2(false));
  ...
  const makers  = { 0: makeUdderedCh1, 1: makeUdderedCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd24"} Uddered but not Herd</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`ud-${tab}-${cur}-${lang}`} text={step.narr} />}

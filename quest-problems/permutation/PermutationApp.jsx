...
export default function PermutationApp() {
  ...
  const [ch3Q, setCh3Q] = useState(() => makePermCh3(false));
  ...
  const makers  = { 0: makePermCh1, 1: makePermCh2, 2: makePermCh3 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>🔢 FJ's Fav Permutation</h1>

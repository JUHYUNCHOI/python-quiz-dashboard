...
const FULL_CPP = [
  ...
  "    }",
  "",
  "    // Bounding box per color (colors are 1..9)",
  ...
  "    }",
  "",
  "    // A color is \"painted later\" if any other (non-zero) color appears inside its bbox",
  "    int ans = 0;",
  ...
  "                if (canvas[r][c] != col && canvas[r][c] != 0) {",
  "                    first = false;",
  "                }",
  "            }",
  "        }",
  ...
  "    int totalColors = 0;",
  "    for (int col = 1; col <= 9; col++) {",
  "        if (seen[col]) totalColors++;",
  "    }",
  "    cout << totalColors - ans << \"\\n\";",
  "    return 0;",
  "}",
];

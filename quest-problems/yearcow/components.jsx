...
const FULL_CPP = [
  ...
  "",
  "    // Zodiac animals in order (12-year cycle)",
  "    auto animals = ['Ox','Tiger','Rabbit','Dragon','Snake',;",
  "            // 'Horse','Goat','Monkey','Rooster','Dog',",
  "            // 'Pig','Rat']",
  "",
  "    long long N; cin >> N;",
  "    auto year = 0  # Bessie's birth year (relative);",
  "",
  "    for (long long _ = 0; _ < N; _++) {",
  "        auto line = input().split();",
  "        // 'born in <prev/next> <Animal> year from <name>'",
  "        auto direction = line[2]  # 'previous' or 'next';",
  "        auto animal = line[3];",
  "        auto idx = animals.index(animal);",
  "        // current animal at year",
  "        auto cur_idx = year % 12;",
  "        if (direction == 'previous') {",
  "            auto diff = (cur_idx - idx) % 12;",
  "            // if diff == 0: diff = 12",
  "            year -= diff;",
  "        else {",
  "            auto diff = (idx - cur_idx) % 12;",
  "            // if diff == 0: diff = 12",
  "            year += diff;",
  "",
  "    cout << abs(year) << \"\\n\";",
...
export function YearCowProgressiveCode({ E, lang = "py", sections }) {

...
export default function Mcc21DvdApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc21DvdCh2(false));
  ...
  const makers  = { 0: makeMcc21DvdCh1, 1: makeMcc21DvdCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcc0"} DVD Screensaver</h1>
      ...
      {step.narr && <Narration key={`m21dv-${tab}-${cur}-${lang}`} text={step.narr} />}

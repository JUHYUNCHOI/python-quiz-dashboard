...
export default function LogicalMoosApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeLogicalCh2(false));
  const TABS = E ? ["📋 Problem", "⚡ Code"] : ["📋 문제", "⚡ 코드"];
  const setters = { 0: setCh1Q, 1: setCh2Q }, states = { 0: ch1Q, 1: ch2Q }, makers = { 0: makeLogicalCh1, 1: makeLogicalCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      {step.narr && <Narration key={`lm-${tab}-${cur}-${lang}`} text={step.narr} />}

...
const FULL_CPP = [
  ...
  "    cin.tie(nullptr);",
  "",
  "    auto rect_area = [&](x1, y1, x2, y2) {   // TODO: type args",
  "        return max(0, x2 - x1) * max(0, y2 - y1);",
  "",
  "    auto overlap = [&](ax1, ay1, ax2, ay2, bx1, by1, bx2, by2) {   // TODO: type args",
  "        auto ox1 = max(ax1, bx1);",
  "        auto oy1 = max(ay1, by1);",
  "        auto ox2 = min(ax2, bx2);",
  "        auto oy2 = min(ay2, by2);",
  "        return rect_area(ox1, oy1, ox2, oy2);",
  "",
  "    // Billboard 1",
  "    // x1, y1, x2, y2 = map(int, input().split())",
  ...
  "    // x5, y5, x6, y6 = map(int, input().split())",
  "",
  "    auto area1 = rect_area(x1, y1, x2, y2);",
  "    auto area2 = rect_area(x3, y3, x4, y4);",
  "",
  "    auto ov1 = overlap(x1, y1, x2, y2, x5, y5, x6, y6);",
  "    auto ov2 = overlap(x3, y3, x4, y4, x5, y5, x6, y6);",
  "",
  "    cout << area1 - ov1 + area2 - ov2 << \"\\n\";",
  "",
  "    return 0;",
  "}",
];
...
export function BillboardProgressiveCode({ E, lang = "py", sections }) {

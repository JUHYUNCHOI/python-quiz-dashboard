...
export default function CornerCoverApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeCornerCoverCh2(false));
  ...
  const makers  = { 0: makeCornerCoverCh1, 1: makeCornerCoverCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcd0"} Corner Cover</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`cc2-${tab}-${cur}-${lang}`} text={step.narr} />}

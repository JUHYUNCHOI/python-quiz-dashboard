...
export default function Mcc20KnightApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc20KnightCh2(false));
  ...
  const makers  = { 0: makeMcc20KnightCh1, 1: makeMcc20KnightCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u265e"} Knight</h1>
      ...
      {step.narr && <Narration key={`m20kn-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export const QUEST_CONCEPT_META: Record<string, QuestConceptMeta> = {
  ...
  milkexchange: {
    type: "simulation",
    concepts_taught: ["circular-array", "in-place-update", "capacity-cap"],
  ...
  majority: {
    type: "algorithm-reveal",
    concepts_taught: ["adjacent-pair-scan", "set-deduplicate"],
    concepts_required: ["loop", "list-basics"],
    difficulty: 2,
    supported_languages: ["py", "cpp"],
    validate_io: [
  ...
  candycane: {
    type: "simulation",
    concepts_taught: ["height-tracking", "linear-eat-simulation"],
  ...
  leaders: {
    type: "algorithm-reveal",
    concepts_taught: ["leader-condition", "two-leader-pair-count"],
  ...
  cannonball: {
    type: "simulation",
    concepts_taught: ["state-cycle-detection", "dictionary-lookup", "ball-simulation"],
    concepts_required: ["loop", "dict-basics", "set-basics", "tuple-basics"],
    difficulty: 3,
    supported_languages: ["py", "cpp"],
    validate_io: [
      { input: "3 3\n3 1 1\n6 0 2\n8 1 3\n",                expected: "1" },

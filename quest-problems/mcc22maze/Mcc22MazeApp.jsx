...
export default function Mcc22MazeApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc22MazeCh2(false));
  ...
  const makers  = { 0: makeMcc22MazeCh1, 1: makeMcc22MazeCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udff0"} Maze</h1>
      ...
      {step.narr && <Narration key={`m22m-${tab}-${cur}-${lang}`} text={step.narr} />}

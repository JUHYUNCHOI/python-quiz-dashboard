...
export default function SqPastureApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSqPastureCh2(false));
  ...
  const makers  = { 0: makeSqPastureCh1, 1: makeSqPastureCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u2b1c"} Square Pasture</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`sp-${tab}-${cur}-${lang}`} text={step.narr} />}

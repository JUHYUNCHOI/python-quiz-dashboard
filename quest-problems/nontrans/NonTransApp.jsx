...
export default function NonTransApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeNonTransCh2(false));
  ...
  const makers  = { 0: makeNonTransCh1, 1: makeNonTransCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udfb2"} Non-Transitive Dice</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`nt-${tab}-${cur}-${lang}`} text={step.narr} />}

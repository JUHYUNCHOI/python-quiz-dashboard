...
import { downloadGiftsPDF, getGiftsSections, getGiftsWalk } from "./components";
...
export default function GiftsApp(props = {}) {
  ...
  const renderContent = () => {
    ...
    if (step.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getGiftsWalk(E)} accent={A} />;
    return null;
  };
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getGiftsWalk(E)} accent={A} />;
    return null;
  };

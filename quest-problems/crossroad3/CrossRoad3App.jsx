...
export default function CrossRoad3App(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeCrossRd3Ch2(false));
  ...
  const makers  = { 0: makeCrossRd3Ch1, 1: makeCrossRd3Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udeaa"} Cross the Road III</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`cr3-${tab}-${cur}-${lang}`} text={step.narr} />}

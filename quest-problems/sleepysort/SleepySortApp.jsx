...
import { downloadSleepySortPDF, getSleepySortSections, getSleepySortWalk } from "./components";
...
export default function SleepySortApp(props = {}) {
  ...
  const renderContent = () => {
    ...
    if (step.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getSleepySortWalk(E, codeLang)} accent={A} />;
    return null;
  };
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getSleepySortWalk(E, codeLang)} accent={A} />;
    return null;
  };

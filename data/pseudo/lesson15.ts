...
만약 찾는 값이 **3**이라면? 끝까지 확인해도 없으니 **-1**을 반환해요.`
        },
        {
          ...
          type: "quiz",
          title: "🧠 퀴즈!",
          content: '배열 [5, 12, 3, 8, 15]에서 선형 검색으로 값 8을 찾으면, 몇 번 비교해야 할까요?',
          options: [
            '4번',
            '3번',
            '5번',
          ...
          answer: 0,
          explanation: '선형 검색은 처음부터 하나씩 비교해요. 5(1번) → 12(2번) → 3(3번) → 8(4번). 4번째에 찾았으므로 **4번** 비교가 필요해요!'
        },
        {
          id: "ch1-quiz2",
          type: "quiz",
          title: "🧠 선형 검색의 특징!",
          content: '선형 검색에 대한 설명으로 올바른 것은?',
          options: [
          ...
          answer: 0,
          explanation: '선형 검색은 처음부터 끝까지 **하나씩** 비교하는 방법이에요. 배열이 정렬되어 있든 없든 상관없이 사용할 수 있어요!'
        },
        {
          id: "ch1-predict1",
          type: "predict",

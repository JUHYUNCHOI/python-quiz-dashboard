...
export default function SubseqMedianApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSubseqMedianCh2(false));
  ...
  const makers  = { 0: makeSubseqMedianCh1, 1: makeSubseqMedianCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcca"} Subseq Median Sum</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`sm-${tab}-${cur}-${lang}`} text={step.narr} />}

...
const FULL_PY = [
  ...
  "",
  "# 합이 D 로 나누어떨어지는 (i < j < k) 세 조합의 개수를 세요",
  "count = 0",
  "for i in range(N):",
  ...
  return [
    {
      ...
      why: [
        ...
        t(E, "Brute force: check all C(N,3) triples. N is small, so O(N³) is fine. Use 64-bit for the count.",
            "완전탐색: C(N,3) 조합 모두 확인. N 이 작아 O(N³) 로 충분. 개수는 64비트로."),
      ],
      pyOnly: [

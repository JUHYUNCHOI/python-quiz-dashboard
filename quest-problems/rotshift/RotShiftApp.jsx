...
const A = "#8b5cf6";
export default function RotShiftApp() {
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd04"} Rotate & Shift</h1>
      ...
      {step.narr && <Narration key={`rs-${tab}-${cur}-${lang}`} text={step.narr} />}

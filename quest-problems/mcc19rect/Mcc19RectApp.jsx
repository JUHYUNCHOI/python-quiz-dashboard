...
export default function Mcc19RectApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc19RectCh2(false));
  ...
  const makers  = { 0: makeMcc19RectCh1, 1: makeMcc19RectCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`m19r-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function WalkHomeApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeWalkHomeCh2(false));
  ...
  const makers  = { 0: makeWalkHomeCh1, 1: makeWalkHomeCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udfe0"} Walking Home</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`wh-${tab}-${cur}-${lang}`} text={step.narr} />}

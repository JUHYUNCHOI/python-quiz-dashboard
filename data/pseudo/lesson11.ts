...
n은 x의 **복사본**이라서, n을 바꿔도 x는 그대로 **5**예요!`
        },
        {
          ...
          type: "quiz",
          title: "🧠 퀴즈!",
          content: 'BYVAL로 전달하면 프로시저 안에서 매개변수를 변경했을 때 원본 변수는?',
          options: [
            '변하지 않는다 (원본 유지)',
            '같이 변한다',
            '에러가 발생한다',
          ...
          answer: 0,
          explanation: '**BYVAL**은 값을 복사해서 전달하기 때문에, 프로시저 안에서 아무리 바꿔도 원본 변수는 **변하지 않아요**!'
        },
        {
          id: "ch1-predict1",
          type: "predict",
...
만약 BYVAL이었다면 원본 a, b는 그대로였을 거예요.`
        },
        {
          ...
          type: "quiz",
          title: "🧠 퀴즈!",
          content: '두 변수의 값을 교환하는 Swap 프로시저에서 매개변수를 BYVAL로 바꾸면 어떻게 될까요?',
          options: [
            '프로시저 안에서만 교환되고, 원본 변수는 바뀌지 않는다',
            '원본 변수도 정상적으로 교환된다',
            '에러가 발생한다',
            '두 변수 모두 0이 된다'
          ],
          answer: 0,
          explanation: 'BYVAL은 복사본을 전달하므로, 프로시저 안에서 교환해도 **원본 변수에는 아무 영향이 없어요**. Swap은 반드시 BYREF를 써야 해요!'
        },
        {
          id: "ch2-predict1",
          type: "predict",

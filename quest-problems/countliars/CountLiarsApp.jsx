...
export default function CountLiarsApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeLiarsCh2(false));
  ...
  const makers  = { 0: makeLiarsCh1, 1: makeLiarsCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udd25"} Counting Liars</h1>
      ...
      {step.narr && <Narration key={`cl-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function Mcc15BahasaApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc15BahasaCh2(false));
  ...
  const makers  = { 0: makeMcc15BahasaCh1, 1: makeMcc15BahasaCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udde3\ufe0f"} Bahasa F</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`mc15b-${tab}-${cur}-${lang}`} text={step.narr} />}

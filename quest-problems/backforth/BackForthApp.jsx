...
export default function BackForthApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeBackForthCh2(false));
  ...
  const makers  = { 0: makeBackForthCh1, 1: makeBackForthCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"🔄"} Back and Forth</h1>
      ...
      {step.narr && <Narration key={`bf-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function Mcc15RectApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc15RectCh2(false));
  ...
  const makers  = { 0: makeMcc15RectCh1, 1: makeMcc15RectCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u25ad"} Rectangle</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`mc15r-${tab}-${cur}-${lang}`} text={step.narr} />}

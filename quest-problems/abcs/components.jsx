...
const FULL_CPP = [
  ...
  "    cin.tie(nullptr);",
  "",
  "    vector<long long> nums; { long long _x; while (cin >> _x) nums.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "    // nums.sort()",
  "",
  "    // The largest number is A+B+C",
  "    auto abc = nums[6];",
...
export function AbcsProgressiveCode({ E, lang = "py", sections }) {

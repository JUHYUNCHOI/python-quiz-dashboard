...
const FULL_CPP = [
  ...
  "    vector<long long> tasks; { long long _x; while (cin >> _x) tasks.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "",
  "    // Sort tasks by duration (greedy)",
  "    // tasks.sort()",
  "",
...
export function InnovationProgressiveCode({ E, lang = "py", sections }) {

...
→ mid = (1 + 6) DIV 2 = 7 DIV 2 = **3**`
        },
        {
          ...
          answer: 0,
          explanation: '이진 검색은 중간값을 기준으로 왼쪽/오른쪽을 결정하기 때문에 배열이 **반드시 정렬**되어 있어야 해요. 정렬되지 않은 배열에는 선형 검색을 사용해야 해요!'
        },
        {
          id: "ch1-quiz2",
          type: "quiz",
          title: "🧠 DIV 계산!",
          content: '(3 + 8) DIV 2 의 결과는?',
          options: [
            '5',
            '6',
            '5.5',
          ...
          answer: 0,
          explanation: '(3 + 8) = 11, 11 DIV 2 = **5** (11 / 2 = 5.5에서 소수점을 버려요). DIV는 항상 정수 결과를 줘요!'
        }
      ]
    },
    {

...
const FULL_CPP = [
  ...
  "    vector<string> g(N);",
  "    for (auto& s : g) cin >> s;",
  "    // Try all 6 permutations of 1->H/P/S",
  "    int best = 0;",
  "    string syms = \"HPS\";",
  "    do {",
  "        int wins = 0;",
  ...
  "        for (auto& s : g) {",
  "            char e = s[0];",
  "            if (b == 0) b = syms[0];   // pick first",
  "            // Bessie wins if her symbol beats elsie's (RPS rule)",
  "            // Mapping: H beats S, S beats P, P beats H",
  "            if ((b == 'H' && e == 'S') || (b == 'S' && e == 'P') || (b == 'P' && e == 'H')) wins++;",
  "        }",
  "        best = max(best, wins);",
  "    } while (next_permutation(syms.begin(), syms.end()));",
  "    cout << best << \"\n\";",
  "    return 0;",
  "}",
];
...
export function Hps17ProgressiveCode({ E, lang = "py", sections }) {

...
export default function TeamTttApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeTttCh2(false));
  ...
  const makers  = { 0: makeTttCh1, 1: makeTttCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u274C"} Team Tic Tac Toe</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`ttt-${tab}-${cur}-${lang}`} text={step.narr} />}

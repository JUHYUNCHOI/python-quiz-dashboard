...
export default function Mcc19Rect2App() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc19Rect2Ch2(false));
  ...
  const makers  = { 0: makeMcc19Rect2Ch1, 1: makeMcc19Rect2Ch2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u25ad"} Rectangle 2</h1>
      ...
      {step.narr && <Narration key={`m19r2-${tab}-${cur}-${lang}`} text={step.narr} />}

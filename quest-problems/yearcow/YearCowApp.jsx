...
export default function YearCowApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeYearCowCh2(false));
  ...
  const makers  = { 0: makeYearCowCh1, 1: makeYearCowCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udc02"} Year of the Cow</h1>
      ...
      {step.narr && <Narration key={`yc-${tab}-${cur}-${lang}`} text={step.narr} />}

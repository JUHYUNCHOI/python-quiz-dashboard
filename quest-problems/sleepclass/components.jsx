...
const FULL_CPP = [
  ...
  "        auto total = sum(a);",
  "",
  "        auto best = N - 1  # worst case: merge all into one;",
  "",
  "        // Try each divisor of total as target period length",
  "        for (long long d = 1; d < total + 1; d++) {",
  "            if (total % d != 0) {",
  "                continue;",
  "            auto target = d;",
  "            // Try to partition into segments summing to target",
  ...
  "                if (curr == 0) {",
  "                    // Number of merges = N - (total // target)",
  "                    auto merges = N - (total // target);",
  "                    auto best = min(best, merges);",
  "",
  "        cout << best << \"\\n\";",
  "",
  "    return 0;",
...
export function SleepClassProgressiveCode({ E, lang = "py", sections }) {

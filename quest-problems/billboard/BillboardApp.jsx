...
export default function BillboardApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeBillboardCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeBillboardCh2(false));
  const [ch3Q, setCh3Q] = useState(() => makeBillboardCh3(false, "py"));

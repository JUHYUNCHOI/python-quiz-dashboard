...
export default function BlocksApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeBlocksCh2(false));
  ...
  const makers  = { 0: makeBlocksCh1, 1: makeBlocksCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\uddf1"} Blocks</h1>
      ...
      {step.narr && <Narration key={`bl-${tab}-${cur}-${lang}`} text={step.narr} />}

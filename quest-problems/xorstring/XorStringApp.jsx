...
export default function XorStringApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeXorStringCh2(false));
  ...
  const makers  = { 0: makeXorStringCh1, 1: makeXorStringCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u2295"} XOR The String</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`xs-${tab}-${cur}-${lang}`} text={step.narr} />}

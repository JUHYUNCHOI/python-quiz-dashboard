...
const OPT_INPUT_CPP = [
  ...
  "using namespace std;",
  "",
  "// s_d = 4...45 (d-1 fours + a 5)",
  "long long s_low(int d) {",
  "    long long v = 5, p = 10;",
  "    for (int i = 1; i < d; i++) { v += 4 * p; p *= 10; }",
  "    return v;",
  "}",
  "",
  "// e_d = 4 99...9 (a 4 + d-1 nines) = 5 * 10^(d-1) - 1",
  "long long s_high(int d) {",
  "    long long p = 1;",
  ...
  return [
    {
      ...
      why: [
        t(E,
          ...
          "빠른 입력 — Python 은 sys.stdin.read, C++ 은 ios::sync_with_stdio(false)."),
        t(E,
    ...
    },
    {
      ...
      why: [
        ...
        t(E,
          "C++ caps d ≤ 11 (N ≤ 10⁹ has at most 10 digits).",
          "C++ 은 d ≤ 11 로 캡 (N ≤ 10⁹ 는 최대 10 자리)."),
      ],
    },
    {

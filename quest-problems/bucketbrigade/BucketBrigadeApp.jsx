...
export default function BucketBrigadeApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeBrigadeCh2(false));
  ...
  const makers  = { 0: makeBrigadeCh1, 1: makeBrigadeCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udea3"} Bucket Brigade</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`bb-${tab}-${cur}-${lang}`} text={step.narr} />}

...
const FULL_CPP = [
  ...
  "",
  "    // for _ in range(int(input())):",
  "        auto answer = [[input().split() for _ in range(3)] for _ in range(2)];",
  "        auto guess = [[input().split() for _ in range(3)] for _ in range(2)];",
  "        // Flatten to 3x3 grids",
  "        auto ans = [input().split() for _ in range(3)];",
  "        auto gue = [input().split() for _ in range(3)];",
  "",
  "        auto green = 0;",
  "        auto yellow = 0;",
  "        auto remaining_ans = {};",

...
const FULL_CPP = [
  ...
  "    long long N; cin >> N;",
  "    auto cows = set();",
  "    auto comfortable = set();",
  "    auto dirs = [(0,1),(0,-1),(1,0),(-1,0)];",
  "",
  "    auto count_neighbors = [&](x, y) {   // TODO: type args",
  "        return sum(1 for dx,dy in dirs if (x+dx,y+dy) in cows);",
  "",
  "    auto update_comfort = [&](x, y) {   // TODO: type args",
  "        auto n = count_neighbors(x, y);",
  "        if (n == 3) {",
  "            // comfortable.add((x,y))",
  "        else {",
  "            // comfortable.discard((x,y))",
...
export function ComfyCowsProgressiveCode({ E, lang = "py", sections }) {

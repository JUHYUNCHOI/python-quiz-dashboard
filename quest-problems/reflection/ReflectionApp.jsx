  ...
  return (
    <div>
      <div style={{ maxWidth: "min(880px, 100%)", margin: "0 auto", padding: "0 clamp(4px, 2vw, 16px)" }}>
            ...
            {TABS.map((label, i) => {
              ...
              return (
                <button key={i} onClick={() => changeTab(i)} style={{
                  ...
                  background: isCurrent ? A : (isVisited ? "#cffafe" : "transparent"),
                  border: `1.5px solid ${isCurrent ? A : (isVisited ? "#67e8f9" : C.border)}`,
                  color: isCurrent ? "#fff" : (isVisited ? "#155e75" : C.dim),
        ...
        {step.narr && <Narration key={`rfl-${tab}-${cur}-${lang}`} text={step.narr} />}

...
const FULL_CPP = [
  ...
  "        else H++;",
  "    }",
  "    // Pair up cows of different breeds. Minimum total = ceil((G+H)/2) — but problem wants groups of 1 or 2.",
  "    // Each pair is 1 photo, leftover singles too.",
  "    int pairs = min(G, H);",
  "    int singles = abs(G - H);",
  "    cout << (pairs + singles) << \"\n\";   // total photos",
  "    return 0;",
...
export function OddPhotosProgressiveCode({ E, lang = "py", sections }) {

...
export default function ProductivityApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeProdCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeProdCh2(false));
  const TABS = E ? ["📋 Problem", "⚡ Code"] : ["📋 문제", "⚡ 코드"];
  const setters = { 0: setCh1Q, 1: setCh2Q }, states = { 0: ch1Q, 1: ch2Q }, makers = { 0: makeProdCh1, 1: makeProdCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>📊 Max Productivity</h1>
      ...
      {step.narr && <Narration key={`pr-${tab}-${cur}-${lang}`} text={step.narr} />}

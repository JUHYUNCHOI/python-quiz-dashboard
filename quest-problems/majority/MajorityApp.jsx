...
export default function MajorityApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMajorityCh2(false));
  ...
  const makers  = { 0: makeMajorityCh1, 1: makeMajorityCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\uddf3\ufe0f"} Majority Opinion</h1>

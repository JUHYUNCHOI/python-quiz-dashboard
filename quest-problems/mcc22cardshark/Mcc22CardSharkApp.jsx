...
export default function Mcc22CardSharkApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc22CardSharkCh2(false));
  ...
  const makers  = { 0: makeMcc22CardSharkCh1, 1: makeMcc22CardSharkCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udccf"} Card Shark</h1>
      ...
      {step.narr && <Narration key={`m22cs-${tab}-${cur}-${lang}`} text={step.narr} />}

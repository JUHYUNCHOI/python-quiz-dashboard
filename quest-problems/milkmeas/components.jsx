...
const FULL_CPP = [
  ...
  "        string name;",
  "        cin >> day >> name >> change;",
  "        events[i] = {day, name, change};",
  "    }",
  "    sort(events.begin(), events.end());",
  "",
  "    map<string, int> milk;",
  "    milk[\"Bessie\"] = 7; milk[\"Elsie\"] = 7; milk[\"Mildred\"] = 7;",
  "    set<string> top = {\"Bessie\", \"Elsie\", \"Mildred\"};",
  "    int changes = 0;",
  "",
  "    for (auto& [day, name, ch] : events) {",
  "        if (!milk.count(name)) milk[name] = 7;",
  "        milk[name] += ch;",
  "        // Re-find top set",
  "        int maxM = 0;",
  "        for (auto& [n, m] : milk) maxM = max(maxM, m);",
  "        set<string> newTop;",
  "        for (auto& [n, m] : milk) if (m == maxM) newTop.insert(n);",
  "        if (newTop != top) { changes++; top = newTop; }",
  "    }",
  "    cout << changes << \"\n\";",
  "    return 0;",
  "}",
...
export function MilkMeasProgressiveCode({ E, lang = "py", sections }) {

...
export default function MagicOrbsApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMagicOrbsCh2(false));
  ...
  const makers  = { 0: makeMagicOrbsCh1, 1: makeMagicOrbsCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd2e"} Magical Orbs</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`mo3-${tab}-${cur}-${lang}`} text={step.narr} />}

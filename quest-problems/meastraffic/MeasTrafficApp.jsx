...
export default function MeasTrafficApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeTrafficCh2(false));
  ...
  const makers  = { 0: makeTrafficCh1, 1: makeTrafficCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\ude97"} Measuring Traffic</h1>
      ...
      {step.narr && <Narration key={`mt-${tab}-${cur}-${lang}`} text={step.narr} />}

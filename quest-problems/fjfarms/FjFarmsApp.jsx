...
export default function FjFarmsApp() {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeFjFarmsCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeFjFarmsCh2(false));
  ...
  const makers  = { 0: makeFjFarmsCh1, 1: makeFjFarmsCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udf31"} FJ Actually Farms</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`fjf-${tab}-${cur}-${lang}`} text={step.narr} />}

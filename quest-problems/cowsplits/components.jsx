...
//   Python: 3/14 (intentional k=1 only quest)
//   C++:    3/14 (intentional k=1 only)
...
export function getCowSplitsSections(E) {
  return [
    ...
    },
    {
      ...
      cppOnly: [
        t(E, "Explicit if/else if/else chain maps each letter to its operation number.",
            "if/else if/else 체인으로 각 글자를 연산 번호로 매핑."),
      ],
    },
  ];
}

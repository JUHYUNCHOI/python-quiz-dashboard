...
export default function Mcc20CityTourApp() {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMcc20CityTourCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMcc20CityTourCh2(false));
  ...
  const makers  = { 0: makeMcc20CityTourCh1, 1: makeMcc20CityTourCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udfd9\ufe0f"} City Tour</h1>
      ...
      {step.narr && <Narration key={`m20ct-${tab}-${cur}-${lang}`} text={step.narr} />}

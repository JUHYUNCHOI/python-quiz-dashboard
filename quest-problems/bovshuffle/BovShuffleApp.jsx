...
export default function BovShuffleApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeShuffleCh2(false));
  ...
  const makers  = { 0: makeShuffleCh1, 1: makeShuffleCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd00"} The Bovine Shuffle</h1>
      ...
      {step.narr && <Narration key={`bs-${tab}-${cur}-${lang}`} text={step.narr} />}

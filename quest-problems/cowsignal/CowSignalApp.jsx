...
export default function CowSignalApp(props = {}) {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeCowSignalCh3(false));
  ...
  const makers  = { 0: makeCowSignalCh1, 1: makeCowSignalCh2, 2: makeCowSignalCh3 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udce1"} The Cow-Signal</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`cs-${tab}-${cur}-${lang}`} text={step.narr} />}

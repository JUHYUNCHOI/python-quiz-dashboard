...
export default function ReachApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeReachCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeReachCh2(false));
  const [ch3Q, setCh3Q] = useState(() => makeReachCh3(false));
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>🐉 Reachability Queries</h1>

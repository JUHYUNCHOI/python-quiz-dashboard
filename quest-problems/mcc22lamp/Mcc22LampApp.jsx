...
export default function Mcc22LampApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc22LampCh2(false));
  ...
  const makers  = { 0: makeMcc22LampCh1, 1: makeMcc22LampCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udca1"} Lamp</h1>
      ...
      {step.narr && <Narration key={`m22l-${tab}-${cur}-${lang}`} text={step.narr} />}

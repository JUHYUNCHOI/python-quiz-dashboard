...
export default function SwapityApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSwapityCh2(false));
  ...
  const makers  = { 0: makeSwapityCh1, 1: makeSwapityCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd00"} Swapity Swap</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`ss-${tab}-${cur}-${lang}`} text={step.narr} />}

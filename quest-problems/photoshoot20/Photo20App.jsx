...
export default function Photo20App(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makePhoto20Ch2(false));
  ...
  const makers  = { 0: makePhoto20Ch1, 1: makePhoto20Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      {step.narr && <Narration key={`ps20-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export function getAstralSections(E) {
  return [
    ...
    },
    {
      ...
      why: [
        t(E, "📖 Find a start (a cell whose 'look back' falls off-grid), then walk forward (+down, +right) storing each cell into path — that's one star path. (Line-by-line notes are in the code comments.)",
            "📖 '시작점'(거꾸로 한 칸이 격자 밖인 칸)을 찾고, 거기서 앞으로 (+down, +right) 한 칸씩 가며 path 에 담아요 — 별 길 하나 완성. (줄별 설명은 코드 주석에.)"),
      ],
      pyOnly: [],
      cppOnly: [],
    },

// 🔒 USACO_VERIFIED — cpid=855, mixmilk (2018 Dec Bronze #1)
...
const FULL_CPP = [
  ...
  "        int amount = milk[src] < space ? milk[src] : space;",
  "        milk[src] -= amount;",
  "        milk[dst] += amount;",
  "    }",
  "    for (int i = 0; i < 3; i++) {",
...
export function getMixMilkSections(E) {
  return [
    {
...
export function MixMilkProgressiveCode(props) {

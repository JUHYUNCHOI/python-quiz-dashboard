...
import { downloadMagicOrbsPDF, getMagicOrbsSections, getMagicOrbsWalk } from "./components";
...
export default function MagicOrbsApp(props = {}) {
  ...
  const renderContent = () => {
    ...
    if (step.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getMagicOrbsWalk(E, codeLang)} accent={A} />;
    return null;
  };
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getMagicOrbsWalk(E, codeLang)} accent={A} />;
    return null;
  };

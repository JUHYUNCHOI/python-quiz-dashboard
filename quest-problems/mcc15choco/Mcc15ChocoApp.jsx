...
export default function Mcc15ChocoApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMcc15ChocoCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMcc15ChocoCh2(false, "py"));

  useEffect(() => {
    setCh2Q(prev => makeMcc15ChocoCh2(E, codeLang).map((s, i) => ({ ...s, answered: prev[i]?.answered, solved: prev[i]?.solved })));
  }, [codeLang, E]);
  ...
  const makers  = { 0: makeMcc15ChocoCh1, 1: (e) => makeMcc15ChocoCh2(e, codeLang) };
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12, alignItems: "center" }}>
          ...
          {showCodeControls && (
            <div style={{ display: "flex", gap: 0, alignItems: "stretch", flexShrink: 0 }}>
              ...
              <button onClick={() => downloadMcc15ChocoPDF(E, getMcc15ChocoSections(E), codeLang)} style={{

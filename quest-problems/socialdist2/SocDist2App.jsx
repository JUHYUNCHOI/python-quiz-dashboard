...
export default function SocDist2App(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeSocDist2Ch2(false));
  ...
  const makers  = { 0: makeSocDist2Ch1, 1: makeSocDist2Ch2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83e\udda0"} Social Distancing II</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`sd2-${tab}-${cur}-${lang}`} text={step.narr} />}

...
const _CX_VARS = [
  ...
  { v: "shortage", ko: "부족한 빨강 (−1)", en: "red shortage (−1)" },
  { v: "wasted_blue", ko: "심술쟁이가 버린 파랑", en: "blue the trickster wastes" },
  { v: "to_fill", ko: "부족분 채우는 칩", en: "chips to fill the rest" },
];
...
export function getChipXchgWalk(E, lang = "py") {
  ...
  if (lang === "cpp") {
    const code = [
      ...
      "        to_fill = shortage;",
      "    } else {                           // " + c("swap loses → blue groups", "환전 손해 → 파랑 그룹"),
      "        to_fill = (shortage / cA) * cB + (shortage % cA);",
      "    }",
      "    return wasted_blue + to_fill + 1;",
      "}",
      "",
      "int main() {",
      "    int T; cin >> T;",

...
export default function CowCollegeApp(props = {}) {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeCowCollegeCh3(false));
  ...
  const makers  = { 0: makeCowCollegeCh1, 1: makeCowCollegeCh2, 2: makeCowCollegeCh3 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\uD83C\uDF93"} Cow College</h1>

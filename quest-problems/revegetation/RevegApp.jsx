...
import { RevegSim, downloadRevegPDF, getRevegSections, getRevegWalk } from "./components";
...
export default function RevegApp(props = {}) {
  ...
  const renderContent = () => {
    ...
    if (step.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getRevegWalk(E, codeLang)} accent={A} />;
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getRevegWalk(E, codeLang)} accent={A} />;

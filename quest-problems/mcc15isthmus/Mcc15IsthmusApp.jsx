...
export default function Mcc15IsthmusApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMcc15IsthmusCh2(false));
  ...
  const makers  = { 0: makeMcc15IsthmusCh1, 1: makeMcc15IsthmusCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u26f0\ufe0f"} Isthmus</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`mc15i-${tab}-${cur}-${lang}`} text={step.narr} />}

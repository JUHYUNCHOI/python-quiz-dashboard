...
그럼 **자동차**는? C++에는 자동차 타입이 없으니까 **직접 만들어야 해요!**

그게 바로 **class**예요.

---

## class를 설계할 때 딱 두 가지만 물어보면 돼요

자동차를 만들려면 어떤 걸 생각해야 할까요?

**🧠 무엇을 기억해야 할까?**
→ 색깔, 현재 속도... 이런 **데이터**가 필요해요
→ C++에서는 **멤버변수(member variable)**

**⚙️ 무엇을 할 수 있어야 할까?**
→ 앞으로 가기, 뒤로 가기, 정보 보여주기...
...
> class를 설계할 때도 **필요한 게 빠지지 않도록** 꼼꼼히 생각해야 해요.`,
        },
        {
          id: "ch1-build",
          type: "explain",
          title: "🚗 자동차 class 만들고 객체 생성하기",
          content: `\`\`\`cpp
class Car {
public:

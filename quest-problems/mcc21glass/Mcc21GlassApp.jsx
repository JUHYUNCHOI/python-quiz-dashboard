...
export default function Mcc21GlassApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMcc21GlassCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMcc21GlassCh2(false));
  const [ch3Q, setCh3Q] = useState(() => makeMcc21GlassCh3(false, "py"));

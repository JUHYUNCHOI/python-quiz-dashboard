...
const FULL_CPP = [
  ...
  "        cout << area << \"\\n\";",
  "    // Feed covers entire billboard",
  "    else if (cx1 <= x1 and cx2 >= x2 and cy1 <= y1 and cy2 >= y2) {",
  "        cout << 0 << \"\\n\";",
  "    // Feed covers full left side",
  "    else if (cx1 <= x1 and cy1 <= y1 and cy2 >= y2) {",
  "        cout << (x2 - cx2) * bh << \"\\n\";",
  "    // Feed covers full right side",
  "    else if (cx2 >= x2 and cy1 <= y1 and cy2 >= y2) {",
  "        cout << (cx1 - x1) * bh << \"\\n\";",
  "    // Feed covers full top side",
  "    else if (cy2 >= y2 and cx1 <= x1 and cx2 >= x2) {",
  "        cout << bw * (cy1 - y1) << \"\\n\";",
  "    // Feed covers full bottom side",
  "    else if (cy1 <= y1 and cx1 <= x1 and cx2 >= x2) {",
  "        cout << bw * (y2 - cy2) << \"\\n\";",
  "    // Otherwise tarp = entire billboard",
  "    else {",
  "        cout << area << \"\\n\";",
...
export function Billboard2ProgressiveCode({ E, lang = "py", sections }) {

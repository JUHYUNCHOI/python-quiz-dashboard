...
export default function InterviewApp() {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeInterviewCh3(false));
  ...
  const makers  = { 0: makeInterviewCh1, 1: makeInterviewCh2, 2: makeInterviewCh3 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>🐄 Bessie's Interview</h1>
      ...
      {step.narr && <Narration key={`int-${tab}-${cur}-${lang}`} text={step.narr} />}

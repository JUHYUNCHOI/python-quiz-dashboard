...
export default function CandyCaneApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeCandyCh2(false));
  ...
  const makers  = { 0: makeCandyCh1, 1: makeCandyCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udf6c"} Candy Cane Feast</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`cc-${tab}-${cur}-${lang}`} text={step.narr} />}

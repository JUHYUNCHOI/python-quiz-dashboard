...
//   Python: 0/1 (WA - overcounts (5 vs 4))
//   C++:    0/1 (WA same as py)
...
const FULL_CPP = [
  ...
  "    // Count grass cells with >= 2 cow neighbors (bipartite-matching scaffold)",
  "    int dx[] = {-1, 1, 0, 0};",
  "    int dy[] = {0, 0, -1, 1};",
  "    int friends = 0;",
  "    for (int r = 0; r < R; r++) {",
  ...
  return [
    {
      ...
      cppOnly: [
        t(E, "Split #include into specific headers (iostream, vector, string).",
            "#include 는 배운 헤더들로 (iostream, vector, string) 나눠 적어."),
        t(E, "dx/dy arrays — common pattern for 4-direction grid neighbors.",
            "dx/dy 배열 — 격자 4방향 이웃을 도는 익숙한 패턴."),
      ],
    },
  ];
}

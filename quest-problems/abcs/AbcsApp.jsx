...
export default function AbcsApp() {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeAbcsCh2(false));
  ...
  const makers  = { 0: makeAbcsCh1, 1: makeAbcsCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udd22"} Do You Know Your ABCs?</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`abc-${tab}-${cur}-${lang}`} text={step.narr} />}

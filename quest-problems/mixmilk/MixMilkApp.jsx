...
export default function MixMilkApp(props = {}) {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeMixMilkCh3(false));
  ...
  const makers  = { 0: makeMixMilkCh1, 1: makeMixMilkCh2, 2: makeMixMilkCh3 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"🥛"} Mixing Milk</h1>
      ...
      {step.narr && <Narration key={`mm-${tab}-${cur}-${lang}`} text={step.narr} />}

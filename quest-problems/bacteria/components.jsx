...
const FULL_CPP = [
  ...
  "            long long spray = -a[i];",
  "            ans += abs(spray);",
  "            // spread effect to a window [i, i+window-1]",
  "            // problem-specific window length; assume 1",
  "            prefix[i] += spray;",
  "            if (i + 1 <= N) prefix[i + 1] += -spray;",
  "        }",
  "    }",
  "    cout << ans << \"\n\";",
  "    return 0;",
...
export function BacteriaProgressiveCode({ E, lang = "py", sections }) {

...
import { downloadSleepyHerdPDF, getSleepyHerdSections, getSleepyHerdWalk } from "./components";
...
export default function SleepyHerdApp(props = {}) {
  ...
  const renderContent = () => {
    ...
    if (step.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getSleepyHerdWalk(E, codeLang)} accent={A} />;
    return null;
  };
  ...
  const renderPreviewBody = (s) => {
    ...
    if (s.type === "codewalk") return <CodeWalk E={E} lang={codeLang} {...getSleepyHerdWalk(E, codeLang)} accent={A} />;
    return null;
  };

...
export default function TeleportApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeTeleportCh2(false));
  ...
  const makers  = { 0: makeTeleportCh1, 1: makeTeleportCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83c\udf00"} Teleportation</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`tp-${tab}-${cur}-${lang}`} text={step.narr} />}

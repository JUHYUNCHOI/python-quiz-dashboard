...
export default function BitcoinApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeBitcoinCh2(false));
  ...
  const makers  = { 0: makeBitcoinCh1, 1: makeBitcoinCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\u20bf"} Bitcoin</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`btc-${tab}-${cur}-${lang}`} text={step.narr} />}

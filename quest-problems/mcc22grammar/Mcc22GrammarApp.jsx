...
export default function Mcc22GrammarApp(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMcc22GrammarCh1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMcc22GrammarCh2(false, "py"));

  useEffect(() => {
    setCh2Q(prev => makeMcc22GrammarCh2(E, codeLang).map((s, i) => ({ ...s, answered: prev[i]?.answered, solved: prev[i]?.solved })));
  }, [codeLang, E]);
  ...
  const makers  = { 0: makeMcc22GrammarCh1, 1: (e) => makeMcc22GrammarCh2(e, codeLang) };
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12, alignItems: "center" }}>
          ...
          {showCodeControls && (
            <div style={{ display: "flex", gap: 0, alignItems: "stretch", flexShrink: 0 }}>
              ...
              <button onClick={() => downloadMcc22GrammarPDF(E, getMcc22GrammarSections(E), codeLang)} style={{

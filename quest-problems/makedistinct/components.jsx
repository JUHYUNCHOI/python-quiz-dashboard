...
export function getMakeDistinctWalk(E, lang = "py") {
  ...
  return { code: FULL_PY, vars: _MD_VARS, beats: [
    ...
    { hi: [22, 24], bubble: t(E, "Otherwise it collides, so push it to cur + K — the next free spot.\nRemember page 3? One more 4 there — pushing by one reached 5, still taken, so it took two pushes to reach 6.\nThat's why one division always gives the exact push count, with no remainder.", "아니면 부딪히니까 cur + K, 즉 다음 빈 자리로 밀어요.\n3쪽에서 4가 하나 더 있었다면, 기억하죠? 한 칸만 밀면 5라 아직 겹쳤고, 6까지 가서야 안 겹쳤어요.\n그렇게 자리들은 K 씩 떨어져 있어서, 나눗셈 한 번으로 몇 번 밀었는지 딱 나와요.") },
  ...
  return [
    {
      ...
      cppOnly: [
        t(E, "long long is required — the answer can pass 2 billion, which int cannot hold.",
            "답이 20억을 넘을 수 있어요. int 에는 안 들어가니 long long 을 꼭 써야 해요."),

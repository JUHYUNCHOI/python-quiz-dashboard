// 🔒 USACO_VERIFIED — cpid=915, sleepyherd (2019 Feb Bronze #1)
...
const FULL_PY = [
  ...
  "with open('herding.in', 'r') as file:",
  ...
  "c = positions[2]",
  "",
  "gap1 = b - a  # a 와 b 사이 간격",
  "gap2 = c - b  # b 와 c 사이 간격",
  "",
  ...
  "    min_moves = 2",
  "",
  "with open('herding.out', 'w') as file:",
  "    file.write(str(min_moves) + '\\n')",
  "    file.write(str(max_moves) + '\\n')",
];

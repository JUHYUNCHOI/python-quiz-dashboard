...
const FULL_CPP = [
  ...
  "",
  "    long long N; cin >> N;",
  "    vector<long long> current; { long long _x; while (cin >> _x) current.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "    vector<long long> preferred; { long long _x; while (cin >> _x) preferred.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "",
  "    // Compute difference array",
  "    auto d = [preferred[i] - current[i] for i in range(N)];",
  "",
  "    // Answer = sum of positive increases + sum of negative decreases",
  "    // Think of it like painting: when diff goes up, new strokes needed",
  "    auto ans = 0;",
  ...
  "",
  "    // Even simpler:",
  "    auto d2 = [preferred[i] - current[i] for i in range(N)];",
  "    auto ans2 = abs(d2[0]);",
...
export function AirCond1ProgressiveCode({ E, lang = "py", sections }) {

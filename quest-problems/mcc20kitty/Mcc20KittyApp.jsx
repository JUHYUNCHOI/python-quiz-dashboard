...
import { makeMcc20KittyCh1, makeMcc20KittyCh2 } from "./chapters";

const A = "#dc2626";

export default function Mcc20KittyApp() {
  ...
  const makers  = { 0: makeMcc20KittyCh1, 1: makeMcc20KittyCh2 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udc31"} Kitty Numbers</h1>
      ...
      {step.narr && <Narration key={`m20kt-${tab}-${cur}-${lang}`} text={step.narr} />}

...
각 숫자에 맞는 동작을 깔끔하게 정리할 수 있답니다.`
        },
        {
          ...
          type: "explain",
          title: "🔢 잠깐! DIV 기억나요?",
          content: `이 예제에서 **DIV** 연산자를 쓸 거예요. 잠깐 복습!

{!blue} **DIV** = 나눗셈의 **몫** (정수 부분만 남기고 나머지 버림!)

| 연산 | 계산 | 결과 |
|------|------|------|
| \`85 DIV 10\` | 85 ÷ 10 = 8.5 → 정수만! | **8** |
| \`73 DIV 10\` | 73 ÷ 10 = 7.3 → 정수만! | **7** |
| \`100 DIV 10\` | 100 ÷ 10 = 10 | **10** |

💡 점수를 10으로 DIV하면 **십의 자리 숫자**만 남아요! → CASE문으로 등급을 나누기 딱 좋아요!`
        },
        {
          id: "ch2-grade",
          type: "explain",

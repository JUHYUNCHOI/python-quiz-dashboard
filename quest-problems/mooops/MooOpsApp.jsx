...
export default function MooOpsApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeMooOpsCh2(false));
  ...
  const makers  = { 0: makeMooOpsCh1, 1: makeMooOpsCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udc2e"} Moo Operations</h1>

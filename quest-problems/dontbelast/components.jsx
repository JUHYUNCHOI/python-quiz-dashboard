...
const FULL_CPP = [
  ...
  "",
  "    auto cows = ['Bessie','Elsie','Daisy','Gertie','Annabelle','Maggie','Henrietta'];",
  "    auto milk = {c: 0 for c in cows};",
  "",
  "    long long N; cin >> N;",
  "    for (long long _ = 0; _ < N; _++) {",
  "        auto parts = input().split();",
  "        auto name = parts[0];",
  "        auto amt = int(parts[1]);",
  "        // milk[name] += amt",
  "",
  "    auto vals = sorted(set(milk.values()));",
  "    if (len(vals) < 2) {",
  "        cout << 'Tie' << \"\\n\";",
  "    else {",
  "        auto second = vals[1];",
  "        auto winners = [c for c in cows if milk[c] == second];",
  "        if (len(winners) == 1) {",
  "            cout << winners[0] << \"\\n\";",
  "        else {",
  "            cout << 'Tie' << \"\\n\";",

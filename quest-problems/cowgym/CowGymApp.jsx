...
export default function CowGymApp(props = {}) {
  ...
  const [ch3Q, setCh3Q] = useState(() => makeCowGymCh3(false));
  ...
  const makers  = { 0: makeCowGymCh1, 1: makeCowGymCh2, 2: makeCowGymCh3 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"🤸"} Cow Gymnastics</h1>
      ...
      {step.narr && <Narration key={`cg-${tab}-${cur}-${lang}`} text={step.narr} />}

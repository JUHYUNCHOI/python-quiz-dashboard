...
const FULL_CPP = [
  ...
  "",
  "    // N, K, T = map(int, input().split())",
  "    vector<long long> active; { long long _x; while (cin >> _x) active.push_back(_x); if (!cin) cin.clear(); } // adapt: read N values",
  "",
  "    // pos[i] = which position cow i is at",
  "    auto pos = list(range(N));",
  "",
  ...
  "",
  "        // 2. Shift: active[j] = (active[j] + 1) % N",
  "        auto active = [(a + 1) % N for a in active];",
  "",
  "    for (long long c = 0; c < N; c++) {",
  "        cout << pos[c] << \"\\n\";",
  "",
...
export function RotShiftProgressiveCode({ E, lang = "py", sections }) {

...
export default function OddPhotosApp(props = {}) {
  ...
  const [ch2Q, setCh2Q] = useState(() => makeOddPhotosCh2(false));
  ...
  const makers  = { 0: makeOddPhotosCh1, 1: makeOddPhotosCh2 };
  ...
  return (
    <div style={{ maxWidth: "min(820px, 100%)", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <h1 style={{ fontSize: 16, fontWeight: 800, color: A, margin: 0, fontFamily: "'Jua',sans-serif" }}>{"\ud83d\udcf8"} Even More Odd Photos</h1>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`op-${tab}-${cur}-${lang}`} text={step.narr} />}

...
export default function Mcc19Rect2App(props = {}) {
  ...
  const [ch1Q, setCh1Q] = useState(() => makeMcc19Rect2Ch1(false));
  const [ch2Q, setCh2Q] = useState(() => makeMcc19Rect2Ch2(false, "py"));

  useEffect(() => {
    setCh2Q(prev => makeMcc19Rect2Ch2(E, codeLang).map((s, i) => ({ ...s, answered: prev[i]?.answered, solved: prev[i]?.solved })));
  }, [codeLang, E]);
  ...
  const makers  = { 0: makeMcc19Rect2Ch1, 1: (e) => makeMcc19Rect2Ch2(e, codeLang) };
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 12, alignItems: "center" }}>
          ...
          {showCodeControls && (
            <div style={{ display: "flex", gap: 0, alignItems: "stretch", flexShrink: 0 }}>
              ...
              <button onClick={() => downloadMcc19Rect2PDF(E, getMcc19Rect2Sections(E), codeLang)} style={{

...
const FULL_CPP = [
  ...
  "    // covered_h[i] = True if cow i is covered by an H patch",
  "    auto patches = 0;",
  "    auto last_g = -1  # rightmost position covered by G patch;",
  "    auto last_h = -1  # rightmost position covered by H patch;",
  "",
  "    for (long long i = 0; i < N; i++) {",
  "        if (s[i] == 'G' and i > last_g) {",
  "            // Place G patch as far right as possible",
  "            patches += 1;",
  "            auto last_g = i + K  # covers i to i+K;",
  "        else if (s[i] == 'H' and i > last_h) {",
  "            // Place H patch as far right as possible",
  "            patches += 1;",
  "            auto last_h = i + K  # covers i to i+K;",
  "",
  "    cout << patches << \"\\n\";",
  "",
  "    return 0;",
...
export function FeedCowsProgressiveCode({ E, lang = "py", sections }) {
